...
`].filter(vs).join(`
`)),o=da(o),o=sl(o,t),o=rl(o,t),a=da(a),a=sl(a,t),a=rl(a,t),o=ol(o),a=ol(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+f);const y=M+m+o,x=M+f+a,C=tl(i,i.VERTEX_SHADER,y),R=tl(i,i.FRAGMENT_SHADER,x);i.attachShader(_,C),i.attachShader(_,R),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(I){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(C).trim(),V=i.getShaderInfoLog(R).trim();let W=!0,z=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,R);else{const j=il(i,C,"vertex"),O=il(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+k+`
`+j+`
`+O)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(F===""||V==="")&&(z=!1);z&&(I.diagnostics={runnable:W,programLog:k,vertexShader:{log:F,prefix:m},fragmentShader:{log:V,prefix:f}})}i.deleteShader(C),i.deleteShader(R),P=new vr(i,_),E=jg(i,_)}let P;this.getUniforms=function(){return P===void 0&&w(this),P};let E;this.getAttributes=function(){return E===void 0&&w(this),E};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=i.getProgramParameter(_,Bg)),v},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=kg++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=C,this.fragmentShader=R,this}let r_=0;class o_{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new a_(e),t.set(e,n)),n}}class a_{constructor(e){this.id=r_++,this.code=e,this.usedTimes=0}}function c_(r,e,t,n,i,s,o){const a=new wa,c=new o_,l=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures;let p=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(E){return l.add(E),E===0?"uv":`uv${E}`}function m(E,v,I,k,F){const V=k.fog,W=F.geometry,z=E.isMeshStandardMaterial?k.environment:null,j=(E.isMeshStandardMaterial?t:e).get(E.envMap||z),O=j&&j.mapping===Cr?j.image.height:null,K=g[E.type];E.precision!==null&&(p=i.getMaxPrecision(E.precision),p!==E.precision&&console.warn("THREE.WebGLProgram.getParameters:",E.precision,"not supported, using",p,"instead."));const ne=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,re=ne!==void 0?ne.length:0;let ve=0;W.morphAttributes.position!==void 0&&(ve=1),W.morphAttributes.normal!==void 0&&(ve=2),W.morphAttributes.color!==void 0&&(ve=3);let Be,Y,ie,_e;if(K){const et=mn[K];Be=et.vertexShader,Y=et.fragmentShader}else Be=E.vertexShader,Y=E.fragmentShader,c.update(E),ie=c.getVertexShaderID(E),_e=c.getFragmentShaderID(E);const oe=r.getRenderTarget(),Se=r.state.buffers.depth.getReversed(),ke=F.isInstancedMesh===!0,Ae=F.isBatchedMesh===!0,pt=!!E.map,ct=!!E.matcap,Ve=!!j,L=!!E.aoMap,qt=!!E.lightMap,Ge=!!E.bumpMap,We=!!E.normalMap,Me=!!E.displacementMap,lt=!!E.emissiveMap,ye=!!E.metalnessMap,A=!!E.roughnessMap,S=E.anisotropy>0,B=E.clearcoat>0,Z=E.dispersion>0,Q=E.iridescence>0,q=E.sheen>0,xe=E.transmission>0,le=S&&!!E.anisotropyMap,fe=B&&!!E.clearcoatMap,Ye=B&&!!E.clearcoatNormalMap,ee=B&&!!E.clearcoatRoughnessMap,pe=Q&&!!E.iridescenceMap,we=Q&&!!E.iridescenceThicknessMap,Re=q&&!!E.sheenColorMap,me=q&&!!E.sheenRoughnessMap,Xe=!!E.specularMap,Ne=!!E.specularColorMap,at=!!E.specularIntensityMap,D=xe&&!!E.transmissionMap,ae=xe&&!!E.thicknessMap,X=!!E.gradientMap,$=!!E.alphaMap,ue=E.alphaTest>0,he=!!E.alphaHash,De=!!E.extensions;let mt=Kn;E.toneMapped&&(oe===null||oe.isXRRenderTarget===!0)&&(mt=r.toneMapping);const Ct={shaderID:K,shaderType:E.type,shaderName:E.name,vertexShader:Be,fragmentShader:Y,defines:E.defines,customVertexShaderID:ie,customFragmentShaderID:_e,isRawShaderMaterial:E.isRawShaderMaterial===!0,glslVersion:E.glslVersion,precision:p,batching:Ae,batchingColor:Ae&&F._colorsTexture!==null,instancing:ke,instancingColor:ke&&F.instanceColor!==null,instancingMorph:ke&&F.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:oe===null?r.outputColorSpace:oe.isXRRenderTarget===!0?oe.texture.colorSpace:Ut,alphaToCoverage:!!E.alphaToCoverage,map:pt,matcap:ct,envMap:Ve,envMapMode:Ve&&j.mapping,envMapCubeUVHeight:O,aoMap:L,lightMap:qt,bumpMap:Ge,normalMap:We,displacementMap:d&&Me,emissiveMap:lt,normalMapObjectSpace:We&&E.normalMapType===ru,normalMapTangentSpace:We&&E.normalMapType===Hl,metalnessMap:ye,roughnessMap:A,anisotropy:S,anisotropyMap:le,clearcoat:B,clearcoatMap:fe,clearcoatNormalMap:Ye,clearcoatRoughnessMap:ee,dispersion:Z,iridescence:Q,iridescenceMap:pe,iridescenceThicknessMap:we,sheen:q,sheenColorMap:Re,sheenRoughnessMap:me,specularMap:Xe,specularColorMap:Ne,specularIntensityMap:at,transmission:xe,transmissionMap:D,thicknessMap:ae,gradientMap:X,opaque:E.transparent===!1&&E.blending===zi&&E.alphaToCoverage===!1,alphaMap:$,alphaTest:ue,alphaHash:he,combine:E.combine,mapUv:pt&&_(E.map.channel),aoMapUv:L&&_(E.aoMap.channel),lightMapUv:qt&&_(E.lightMap.channel),bumpMapUv:Ge&&_(E.bumpMap.channel),normalMapUv:We&&_(E.normalMap.channel),displacementMapUv:Me&&_(E.displacementMap.channel),emissiveMapUv:lt&&_(E.emissiveMap.channel),metalnessMapUv:ye&&_(E.metalnessMap.channel),roughnessMapUv:A&&_(E.roughnessMap.channel),anisotropyMapUv:le&&_(E.anisotropyMap.channel),clearcoatMapUv:fe&&_(E.clearcoatMap.channel),clearcoatNormalMapUv:Ye&&_(E.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ee&&_(E.clearcoatRoughnessMap.channel),iridescenceMapUv:pe&&_(E.iridescenceMap.channel),iridescenceThicknessMapUv:we&&_(E.iridescenceThicknessMap.channel),sheenColorMapUv:Re&&_(E.sheenColorMap.channel),sheenRoughnessMapUv:me&&_(E.sheenRoughnessMap.channel),specularMapUv:Xe&&_(E.specularMap.channel),specularColorMapUv:Ne&&_(E.specularColorMap.channel),specularIntensityMapUv:at&&_(E.specularIntensityMap.channel),transmissionMapUv:D&&_(E.transmissionMap.channel),thicknessMapUv:ae&&_(E.thicknessMap.channel),alphaMapUv:$&&_(E.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(We||S),vertexColors:E.vertexColors,vertexAlphas:E.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!W.attributes.uv&&(pt||$),fog:!!V,useFog:E.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:E.flatShading===!0,sizeAttenuation:E.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:Se,skinning:F.isSkinnedMesh===!0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:re,morphTextureStride:ve,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:E.dithering,shadowMapEnabled:r.shadowMap.enabled&&I.length>0,shadowMapType:r.shadowMap.type,toneMapping:mt,decodeVideoTexture:pt&&E.map.isVideoTexture===!0&&He.getTransfer(E.map.colorSpace)===it,decodeVideoTextureEmissive:lt&&E.emissiveMap.isVideoTexture===!0&&He.getTransfer(E.emissiveMap.colorSpace)===it,premultipliedAlpha:E.premultipliedAlpha,doubleSided:E.side===Dt,flipSided:E.side===Gt,useDepthPacking:E.depthPacking>=0,depthPacking:E.depthPacking||0,index0AttributeName:E.index0AttributeName,extensionClipCullDistance:De&&E.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(De&&E.extensions.multiDraw===!0||Ae)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:E.customProgramCacheKey()};return Ct.vertexUv1s=l.has(1),Ct.vertexUv2s=l.has(2),Ct.vertexUv3s=l.has(3),l.clear(),Ct}function f(E){const v=[];if(E.shaderID?v.push(E.shaderID):(v.push(E.customVertexShaderID),v.push(E.customFragmentShaderID)),E.defines!==void 0)for(const I in E.defines)v.push(I),v.push(E.defines[I]);return E.isRawShaderMaterial===!1&&(M(v,E),y(v,E),v.push(r.outputColorSpace)),v.push(E.customProgramCacheKey),v.join()}function M(E,v){E.push(v.precision),E.push(v.outputColorSpace),E.push(v.envMapMode),E.push(v.envMapCubeUVHeight),E.push(v.mapUv),E.push(v.alphaMapUv),E.push(v.lightMapUv),E.push(v.aoMapUv),E.push(v.bumpMapUv),E.push(v.normalMapUv),E.push(v.displacementMapUv),E.push(v.emissiveMapUv),E.push(v.metalnessMapUv),E.push(v.roughnessMapUv),E.push(v.anisotropyMapUv),E.push(v.clearcoatMapUv),E.push(v.clearcoatNormalMapUv),E.push(v.clearcoatRoughnessMapUv),E.push(v.iridescenceMapUv),E.push(v.iridescenceThicknessMapUv),E.push(v.sheenColorMapUv),E.push(v.sheenRoughnessMapUv),E.push(v.specularMapUv),E.push(v.specularColorMapUv),E.push(v.specularIntensityMapUv),E.push(v.transmissionMapUv),E.push(v.thicknessMapUv),E.push(v.combine),E.push(v.fogExp2),E.push(v.sizeAttenuation),E.push(v.morphTargetsCount),E.push(v.morphAttributeCount),E.push(v.numDirLights),E.push(v.numPointLights),E.push(v.numSpotLights),E.push(v.numSpotLightMaps),E.push(v.numHemiLights),E.push(v.numRectAreaLights),E.push(v.numDirLightShadows),E.push(v.numPointLightShadows),E.push(v.numSpotLightShadows),E.push(v.numSpotLightShadowsWithMaps),E.push(v.numLightProbes),E.push(v.shadowMapType),E.push(v.toneMapping),E.push(v.numClippingPlanes),E.push(v.numClipIntersection),E.push(v.depthPacking)}function y(E,v){a.disableAll(),v.supportsVertexTextures&&a.enable(0),v.instancing&&a.enable(1),v.instancingColor&&a.enable(2),v.instancingMorph&&a.enable(3),v.matcap&&a.enable(4),v.envMap&&a.enable(5),v.normalMapObjectSpace&&a.enable(6),v.normalMapTangentSpace&&a.enable(7),v.clearcoat&&a.enable(8),v.iridescence&&a.enable(9),v.alphaTest&&a.enable(10),v.vertexColors&&a.enable(11),v.vertexAlphas&&a.enable(12),v.vertexUv1s&&a.enable(13),v.vertexUv2s&&a.enable(14),v.vertexUv3s&&a.enable(15),v.vertexTangents&&a.enable(16),v.anisotropy&&a.enable(17),v.alphaHash&&a.enable(18),v.batching&&a.enable(19),v.dispersion&&a.enable(20),v.batchingColor&&a.enable(21),E.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.reverseDepthBuffer&&a.enable(4),v.skinning&&a.enable(5),v.morphTargets&&a.enable(6),v.morphNormals&&a.enable(7),v.morphColors&&a.enable(8),v.premultipliedAlpha&&a.enable(9),v.shadowMapEnabled&&a.enable(10),v.doubleSided&&a.enable(11),v.flipSided&&a.enable(12),v.useDepthPacking&&a.enable(13),v.dithering&&a.enable(14),v.transmission&&a.enable(15),v.sheen&&a.enable(16),v.opaque&&a.enable(17),v.pointsUvs&&a.enable(18),v.decodeVideoTexture&&a.enable(19),v.decodeVideoTextureEmissive&&a.enable(20),v.alphaToCoverage&&a.enable(21),E.push(a.mask)}function x(E){const v=g[E.type];let I;if(v){const k=mn[v];I=$u.clone(k.uniforms)}else I=E.uniforms;return I}function C(E,v){let I;for(let k=0,F=h.length;k<F;k++){const V=h[k];if(V.cacheKey===v){I=V,++I.usedTimes;break}}return I===void 0&&(I=new s_(r,v,E,s),h.push(I)),I}function R(E){if(--E.usedTimes===0){const v=h.indexOf(E);h[v]=h[h.length-1],h.pop(),E.destroy()}}function w(E){c.remove(E)}function P(){c.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:x,acquireProgram:C,releaseProgram:R,releaseShaderCache:w,programs:h,dispose:P}}function l_(){let r=new WeakMap;function e(o){return r.has(o)}function t(o){let a=r.get(o);return a===void 0&&(a={},r.set(o,a)),a}function n(o){r.delete(o)}function i(o,a,c){r.get(o)[a]=c}function s(){r=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:s}}function h_(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function cl(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function ll(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function o(u,d,p,g,_,m){let f=r[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},r[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=_,f.group=m),e++,f}function a(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.push(f):p.transparent===!0?i.push(f):t.push(f)}function c(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?i.unshift(f):t.unshift(f)}function l(u,d){t.length>1&&t.sort(u||h_),n.length>1&&n.sort(d||cl),i.length>1&&i.sort(d||cl)}function h(){for(let u=e,d=r.length;u<d;u++){const p=r[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:a,unshift:c,finish:h,sort:l}}function u_(){let r=new WeakMap;function e(n,i){const s=r.get(n);let o;return s===void 0?(o=new ll,r.set(n,[o])):i>=s.length?(o=new ll,s.push(o)):o=s[i],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function d_(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new T,color:new Pe};break;case"SpotLight":t={position:new T,direction:new T,color:new Pe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new T,color:new Pe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new T,skyColor:new Pe,groundColor:new Pe};break;case"RectAreaLight":t={color:new Pe,position:new T,halfWidth:new T,halfHeight:new T};break}return r[e.id]=t,t}}}function f_(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let p_=0;function m_(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function g_(r){const e=new d_,t=f_(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new T);const i=new T,s=new Le,o=new Le;function a(l){let h=0,u=0,d=0;for(let E=0;E<9;E++)n.probe[E].set(0,0,0);let p=0,g=0,_=0,m=0,f=0,M=0,y=0,x=0,C=0,R=0,w=0;l.sort(m_);for(let E=0,v=l.length;E<v;E++){const I=l[E],k=I.color,F=I.intensity,V=I.distance,W=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)h+=k.r*F,u+=k.g*F,d+=k.b*F;else if(I.isLightProbe){for(let z=0;z<9;z++)n.probe[z].addScaledVector(I.sh.coefficients[z],F);w++}else if(I.isDirectionalLight){const z=e.get(I);if(z.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){const j=I.shadow,O=t.get(I);O.shadowIntensity=j.intensity,O.shadowBias=j.bias,O.shadowNormalBias=j.normalBias,O.shadowRadius=j.radius,O.shadowMapSize=j.mapSize,n.directionalShadow[p]=O,n.directionalShadowMap[p]=W,n.directionalShadowMatrix[p]=I.shadow.matrix,M++}n.directional[p]=z,p++}else if(I.isSpotLight){const z=e.get(I);z.position.setFromMatrixPosition(I.matrixWorld),z.color.copy(k).multiplyScalar(F),z.distance=V,z.coneCos=Math.cos(I.angle),z.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),z.decay=I.decay,n.spot[_]=z;const j=I.shadow;if(I.map&&(n.spotLightMap[C]=I.map,C++,j.updateMatrices(I),I.castShadow&&R++),n.spotLightMatrix[_]=j.matrix,I.castShadow){const O=t.get(I);O.shadowIntensity=j.intensity,O.shadowBias=j.bias,O.shadowNormalBias=j.normalBias,O.shadowRadius=j.radius,O.shadowMapSize=j.mapSize,n.spotShadow[_]=O,n.spotShadowMap[_]=W,x++}_++}else if(I.isRectAreaLight){const z=e.get(I);z.color.copy(k).multiplyScalar(F),z.halfWidth.set(I.width*.5,0,0),z.halfHeight.set(0,I.height*.5,0),n.rectArea[m]=z,m++}else if(I.isPointLight){const z=e.get(I);if(z.color.copy(I.color).multiplyScalar(I.intensity),z.distance=I.distance,z.decay=I.decay,I.castShadow){const j=I.shadow,O=t.get(I);O.shadowIntensity=j.intensity,O.shadowBias=j.bias,O.shadowNormalBias=j.normalBias,O.shadowRadius=j.radius,O.shadowMapSize=j.mapSize,O.shadowCameraNear=j.camera.near,O.shadowCameraFar=j.camera.far,n.pointShadow[g]=O,n.pointShadowMap[g]=W,n.pointShadowMatrix[g]=I.shadow.matrix,y++}n.point[g]=z,g++}else if(I.isHemisphereLight){const z=e.get(I);z.skyColor.copy(I.color).multiplyScalar(F),z.groundColor.copy(I.groundColor).multiplyScalar(F),n.hemi[f]=z,f++}}m>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=se.LTC_FLOAT_1,n.rectAreaLTC2=se.LTC_FLOAT_2):(n.rectAreaLTC1=se.LTC_HALF_1,n.rectAreaLTC2=se.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const P=n.hash;(P.directionalLength!==p||P.pointLength!==g||P.spotLength!==_||P.rectAreaLength!==m||P.hemiLength!==f||P.numDirectionalShadows!==M||P.numPointShadows!==y||P.numSpotShadows!==x||P.numSpotMaps!==C||P.numLightProbes!==w)&&(n.directional.length=p,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=f,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=x+C-R,n.spotLightMap.length=C,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=w,P.directionalLength=p,P.pointLength=g,P.spotLength=_,P.rectAreaLength=m,P.hemiLength=f,P.numDirectionalShadows=M,P.numPointShadows=y,P.numSpotShadows=x,P.numSpotMaps=C,P.numLightProbes=w,n.version=p_++)}function c(l,h){let u=0,d=0,p=0,g=0,_=0;const m=h.matrixWorldInverse;for(let f=0,M=l.length;f<M;f++){const y=l[f];if(y.isDirectionalLight){const x=n.directional[u];x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),u++}else if(y.isSpotLight){const x=n.spot[p];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),p++}else if(y.isRectAreaLight){const x=n.rectArea[g];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),o.identity(),s.copy(y.matrixWorld),s.premultiply(m),o.extractRotation(s),x.halfWidth.set(y.width*.5,0,0),x.halfHeight.set(0,y.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),g++}else if(y.isPointLight){const x=n.point[d];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),d++}else if(y.isHemisphereLight){const x=n.hemi[_];x.direction.setFromMatrixPosition(y.matrixWorld),x.direction.transformDirection(m),_++}}}return{setup:a,setupView:c,state:n}}function hl(r){const e=new g_(r),t=[],n=[];function i(h){l.camera=h,t.length=0,n.length=0}function s(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function c(h){e.setupView(t,h)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:a,setupLightsView:c,pushLight:s,pushShadow:o}}function __(r){let e=new WeakMap;function t(i,s=0){const o=e.get(i);let a;return o===void 0?(a=new hl(r),e.set(i,[a])):s>=o.length?(a=new hl(r),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}const x_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function y_(r,e,t){let n=new Pa;const i=new Te,s=new Te,o=new Ke,a=new fd({depthPacking:su}),c=new pd,l={},h=t.maxTextureSize,u={[Ln]:Gt,[Gt]:Ln,[Dt]:Dt},d=new Zn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:x_,fragmentShader:v_}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new vt;g.setAttribute("position",new dt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new te(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Al;let f=this.type;this.render=function(R,w,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const E=r.getRenderTarget(),v=r.getActiveCubeFace(),I=r.getActiveMipmapLevel(),k=r.state;k.setBlending(qn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const F=f!==wn&&this.type===wn,V=f===wn&&this.type!==wn;for(let W=0,z=R.length;W<z;W++){const j=R[W],O=j.shadow;if(O===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;i.copy(O.mapSize);const K=O.getFrameExtents();if(i.multiply(K),s.copy(O.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/K.x),i.x=s.x*K.x,O.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/K.y),i.y=s.y*K.y,O.mapSize.y=s.y)),O.map===null||F===!0||V===!0){const re=this.type!==wn?{minFilter:kt,magFilter:kt}:{};O.map!==null&&O.map.dispose(),O.map=new gi(i.x,i.y,re),O.map.texture.name=j.name+".shadowMap",O.camera.updateProjectionMatrix()}r.setRenderTarget(O.map),r.clear();const ne=O.getViewportCount();for(let re=0;re<ne;re++){const ve=O.getViewport(re);o.set(s.x*ve.x,s.y*ve.y,s.x*ve.z,s.y*ve.w),k.viewport(o),O.updateMatrices(j,re),n=O.getFrustum(),x(w,P,O.camera,j,this.type)}O.isPointLightShadow!==!0&&this.type===wn&&M(O,P),O.needsUpdate=!1}f=this.type,m.needsUpdate=!1,r.setRenderTarget(E,v,I)};function M(R,w){const P=e.update(_);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new gi(i.x,i.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,r.setRenderTarget(R.mapPass),r.clear(),r.renderBufferDirect(w,null,P,d,_,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,r.setRenderTarget(R.map),r.clear(),r.renderBufferDirect(w,null,P,p,_,null)}function y(R,w,P,E){let v=null;const I=P.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(I!==void 0)v=I;else if(v=P.isPointLight===!0?c:a,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const k=v.uuid,F=w.uuid;let V=l[k];V===void 0&&(V={},l[k]=V);let W=V[F];W===void 0&&(W=v.clone(),V[F]=W,w.addEventListener("dispose",C)),v=W}if(v.visible=w.visible,v.wireframe=w.wireframe,E===wn?v.side=w.shadowSide!==null?w.shadowSide:w.side:v.side=w.shadowSide!==null?w.shadowSide:u[w.side],v.alphaMap=w.alphaMap,v.alphaTest=w.alphaTest,v.map=w.map,v.clipShadows=w.clipShadows,v.clippingPlanes=w.clippingPlanes,v.clipIntersection=w.clipIntersection,v.displacementMap=w.displacementMap,v.displacementScale=w.displacementScale,v.displacementBias=w.displacementBias,v.wireframeLinewidth=w.wireframeLinewidth,v.linewidth=w.linewidth,P.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const k=r.properties.get(v);k.light=P}return v}function x(R,w,P,E,v){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&v===wn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,R.matrixWorld);const F=e.update(R),V=R.material;if(Array.isArray(V)){const W=F.groups;for(let z=0,j=W.length;z<j;z++){const O=W[z],K=V[O.materialIndex];if(K&&K.visible){const ne=y(R,K,E,v);R.onBeforeShadow(r,R,w,P,F,ne,O),r.renderBufferDirect(P,null,F,ne,R,O),R.onAfterShadow(r,R,w,P,F,ne,O)}}}else if(V.visible){const W=y(R,V,E,v);R.onBeforeShadow(r,R,w,P,F,W,null),r.renderBufferDirect(P,null,F,W,R,null),R.onAfterShadow(r,R,w,P,F,W,null)}}const k=R.children;for(let F=0,V=k.length;F<V;F++)x(k[F],w,P,E,v)}function C(R){R.target.removeEventListener("dispose",C);for(const P in l){const E=l[P],v=R.target.uuid;v in E&&(E[v].dispose(),delete E[v])}}}const M_={[bo]:To,[Ao]:Co,[wo]:Po,[Wi]:Ro,[To]:bo,[Co]:Ao,[Po]:wo,[Ro]:Wi};function S_(r,e){function t(){let D=!1;const ae=new Ke;let X=null;const $=new Ke(0,0,0,0);return{setMask:function(ue){X!==ue&&!D&&(r.colorMask(ue,ue,ue,ue),X=ue)},setLocked:function(ue){D=ue},setClear:function(ue,he,De,mt,Ct){Ct===!0&&(ue*=mt,he*=mt,De*=mt),ae.set(ue,he,De,mt),$.equals(ae)===!1&&(r.clearColor(ue,he,De,mt),$.copy(ae))},reset:function(){D=!1,X=null,$.set(-1,0,0,0)}}}function n(){let D=!1,ae=!1,X=null,$=null,ue=null;return{setReversed:function(he){if(ae!==he){const De=e.get("EXT_clip_control");ae?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);const mt=ue;ue=null,this.setClear(mt)}ae=he},getReversed:function(){return ae},setTest:function(he){he?oe(r.DEPTH_TEST):Se(r.DEPTH_TEST)},setMask:function(he){X!==he&&!D&&(r.depthMask(he),X=he)},setFunc:function(he){if(ae&&(he=M_[he]),$!==he){switch(he){case bo:r.depthFunc(r.NEVER);break;case To:r.depthFunc(r.ALWAYS);break;case Ao:r.depthFunc(r.LESS);break;case Wi:r.depthFunc(r.LEQUAL);break;case wo:r.depthFunc(r.EQUAL);break;case Ro:r.depthFunc(r.GEQUAL);break;case Co:r.depthFunc(r.GREATER);break;case Po:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}$=he}},setLocked:function(he){D=he},setClear:function(he){ue!==he&&(ae&&(he=1-he),r.clearDepth(he),ue=he)},reset:function(){D=!1,X=null,$=null,ue=null,ae=!1}}}function i(){let D=!1,ae=null,X=null,$=null,ue=null,he=null,De=null,mt=null,Ct=null;return{setTest:function(et){D||(et?oe(r.STENCIL_TEST):Se(r.STENCIL_TEST))},setMask:function(et){ae!==et&&!D&&(r.stencilMask(et),ae=et)},setFunc:function(et,sn,yn){(X!==et||$!==sn||ue!==yn)&&(r.stencilFunc(et,sn,yn),X=et,$=sn,ue=yn)},setOp:function(et,sn,yn){(he!==et||De!==sn||mt!==yn)&&(r.stencilOp(et,sn,yn),he=et,De=sn,mt=yn)},setLocked:function(et){D=et},setClear:function(et){Ct!==et&&(r.clearStencil(et),Ct=et)},reset:function(){D=!1,ae=null,X=null,$=null,ue=null,he=null,De=null,mt=null,Ct=null}}}const s=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,M=null,y=null,x=null,C=null,R=null,w=new Pe(0,0,0),P=0,E=!1,v=null,I=null,k=null,F=null,V=null;const W=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,j=0;const O=r.getParameter(r.VERSION);O.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(O)[1]),z=j>=1):O.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),z=j>=2);let K=null,ne={};const re=r.getParameter(r.SCISSOR_BOX),ve=r.getParameter(r.VIEWPORT),Be=new Ke().fromArray(re),Y=new Ke().fromArray(ve);function ie(D,ae,X,$){const ue=new Uint8Array(4),he=r.createTexture();r.bindTexture(D,he),r.texParameteri(D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(D,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let De=0;De<X;De++)D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY?r.texImage3D(ae,0,r.RGBA,1,1,$,0,r.RGBA,r.UNSIGNED_BYTE,ue):r.texImage2D(ae+De,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ue);return he}const _e={};_e[r.TEXTURE_2D]=ie(r.TEXTURE_2D,r.TEXTURE_2D,1),_e[r.TEXTURE_CUBE_MAP]=ie(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),_e[r.TEXTURE_2D_ARRAY]=ie(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),_e[r.TEXTURE_3D]=ie(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),oe(r.DEPTH_TEST),o.setFunc(Wi),Ge(!1),We(Ya),oe(r.CULL_FACE),L(qn);function oe(D){h[D]!==!0&&(r.enable(D),h[D]=!0)}function Se(D){h[D]!==!1&&(r.disable(D),h[D]=!1)}function ke(D,ae){return u[D]!==ae?(r.bindFramebuffer(D,ae),u[D]=ae,D===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=ae),D===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ae(D,ae){let X=p,$=!1;if(D){X=d.get(ae),X===void 0&&(X=[],d.set(ae,X));const ue=D.textures;if(X.length!==ue.length||X[0]!==r.COLOR_ATTACHMENT0){for(let he=0,De=ue.length;he<De;he++)X[he]=r.COLOR_ATTACHMENT0+he;X.length=ue.length,$=!0}}else X[0]!==r.BACK&&(X[0]=r.BACK,$=!0);$&&r.drawBuffers(X)}function pt(D){return g!==D?(r.useProgram(D),g=D,!0):!1}const ct={[ui]:r.FUNC_ADD,[Th]:r.FUNC_SUBTRACT,[Ah]:r.FUNC_REVERSE_SUBTRACT};ct[wh]=r.MIN,ct[Rh]=r.MAX;const Ve={[Ch]:r.ZERO,[Ph]:r.ONE,[Ih]:r.SRC_COLOR,[So]:r.SRC_ALPHA,[Oh]:r.SRC_ALPHA_SATURATE,[Nh]:r.DST_COLOR,[Dh]:r.DST_ALPHA,[Lh]:r.ONE_MINUS_SRC_COLOR,[Eo]:r.ONE_MINUS_SRC_ALPHA,[Fh]:r.ONE_MINUS_DST_COLOR,[Uh]:r.ONE_MINUS_DST_ALPHA,[Bh]:r.CONSTANT_COLOR,[kh]:r.ONE_MINUS_CONSTANT_COLOR,[zh]:r.CONSTANT_ALPHA,[Hh]:r.ONE_MINUS_CONSTANT_ALPHA};function L(D,ae,X,$,ue,he,De,mt,Ct,et){if(D===qn){_===!0&&(Se(r.BLEND),_=!1);return}if(_===!1&&(oe(r.BLEND),_=!0),D!==bh){if(D!==m||et!==E){if((f!==ui||x!==ui)&&(r.blendEquation(r.FUNC_ADD),f=ui,x=ui),et)switch(D){case zi:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case ja:r.blendFunc(r.ONE,r.ONE);break;case qa:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ka:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case zi:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case ja:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case qa:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ka:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}M=null,y=null,C=null,R=null,w.set(0,0,0),P=0,m=D,E=et}return}ue=ue||ae,he=he||X,De=De||$,(ae!==f||ue!==x)&&(r.blendEquationSeparate(ct[ae],ct[ue]),f=ae,x=ue),(X!==M||$!==y||he!==C||De!==R)&&(r.blendFuncSeparate(Ve[X],Ve[$],Ve[he],Ve[De]),M=X,y=$,C=he,R=De),(mt.equals(w)===!1||Ct!==P)&&(r.blendColor(mt.r,mt.g,mt.b,Ct),w.copy(mt),P=Ct),m=D,E=!1}function qt(D,ae){D.side===Dt?Se(r.CULL_FACE):oe(r.CULL_FACE);let X=D.side===Gt;ae&&(X=!X),Ge(X),D.blending===zi&&D.transparent===!1?L(qn):L(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),s.setMask(D.colorWrite);const $=D.stencilWrite;a.setTest($),$&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),lt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?oe(r.SAMPLE_ALPHA_TO_COVERAGE):Se(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(D){v!==D&&(D?r.frontFace(r.CW):r.frontFace(r.CCW),v=D)}function We(D){D!==Sh?(oe(r.CULL_FACE),D!==I&&(D===Ya?r.cullFace(r.BACK):D===Eh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Se(r.CULL_FACE),I=D}function Me(D){D!==k&&(z&&r.lineWidth(D),k=D)}function lt(D,ae,X){D?(oe(r.POLYGON_OFFSET_FILL),(F!==ae||V!==X)&&(r.polygonOffset(ae,X),F=ae,V=X)):Se(r.POLYGON_OFFSET_FILL)}function ye(D){D?oe(r.SCISSOR_TEST):Se(r.SCISSOR_TEST)}function A(D){D===void 0&&(D=r.TEXTURE0+W-1),K!==D&&(r.activeTexture(D),K=D)}function S(D,ae,X){X===void 0&&(K===null?X=r.TEXTURE0+W-1:X=K);let $=ne[X];$===void 0&&($={type:void 0,texture:void 0},ne[X]=$),($.type!==D||$.texture!==ae)&&(K!==X&&(r.activeTexture(X),K=X),r.bindTexture(D,ae||_e[D]),$.type=D,$.texture=ae)}function B(){const D=ne[K];D!==void 0&&D.type!==void 0&&(r.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Z(){try{r.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Q(){try{r.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function q(){try{r.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{r.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function le(){try{r.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{r.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ye(){try{r.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ee(){try{r.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function pe(){try{r.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(){try{r.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(D){Be.equals(D)===!1&&(r.scissor(D.x,D.y,D.z,D.w),Be.copy(D))}function me(D){Y.equals(D)===!1&&(r.viewport(D.x,D.y,D.z,D.w),Y.copy(D))}function Xe(D,ae){let X=l.get(ae);X===void 0&&(X=new WeakMap,l.set(ae,X));let $=X.get(D);$===void 0&&($=r.getUniformBlockIndex(ae,D.name),X.set(D,$))}function Ne(D,ae){const $=l.get(ae).get(D);c.get(ae)!==$&&(r.uniformBlockBinding(ae,$,D.__bindingPointIndex),c.set(ae,$))}function at(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},K=null,ne={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,M=null,y=null,x=null,C=null,R=null,w=new Pe(0,0,0),P=0,E=!1,v=null,I=null,k=null,F=null,V=null,Be.set(0,0,r.canvas.width,r.canvas.height),Y.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:oe,disable:Se,bindFramebuffer:ke,drawBuffers:Ae,useProgram:pt,setBlending:L,setMaterial:qt,setFlipSided:Ge,setCullFace:We,setLineWidth:Me,setPolygonOffset:lt,setScissorTest:ye,activeTexture:A,bindTexture:S,unbindTexture:B,compressedTexImage2D:Z,compressedTexImage3D:Q,texImage2D:pe,texImage3D:we,updateUBOMapping:Xe,uniformBlockBinding:Ne,texStorage2D:Ye,texStorage3D:ee,texSubImage2D:q,texSubImage3D:xe,compressedTexSubImage2D:le,compressedTexSubImage3D:fe,scissor:Re,viewport:me,reset:at}}function E_(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Te,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,S){return p?new OffscreenCanvas(A,S):Rs("canvas")}function _(A,S,B){let Z=1;const Q=ye(A);if((Q.width>B||Q.height>B)&&(Z=B/Math.max(Q.width,Q.height)),Z<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const q=Math.floor(Z*Q.width),xe=Math.floor(Z*Q.height);u===void 0&&(u=g(q,xe));const le=S?g(q,xe):u;return le.width=q,le.height=xe,le.getContext("2d").drawImage(A,0,0,q,xe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+q+"x"+xe+")."),le}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),A;return A}function m(A){return A.generateMipmaps}function f(A){r.generateMipmap(A)}function M(A){return A.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?r.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function y(A,S,B,Z,Q=!1){if(A!==null){if(r[A]!==void 0)return r[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=S;if(S===r.RED&&(B===r.FLOAT&&(q=r.R32F),B===r.HALF_FLOAT&&(q=r.R16F),B===r.UNSIGNED_BYTE&&(q=r.R8)),S===r.RED_INTEGER&&(B===r.UNSIGNED_BYTE&&(q=r.R8UI),B===r.UNSIGNED_SHORT&&(q=r.R16UI),B===r.UNSIGNED_INT&&(q=r.R32UI),B===r.BYTE&&(q=r.R8I),B===r.SHORT&&(q=r.R16I),B===r.INT&&(q=r.R32I)),S===r.RG&&(B===r.FLOAT&&(q=r.RG32F),B===r.HALF_FLOAT&&(q=r.RG16F),B===r.UNSIGNED_BYTE&&(q=r.RG8)),S===r.RG_INTEGER&&(B===r.UNSIGNED_BYTE&&(q=r.RG8UI),B===r.UNSIGNED_SHORT&&(q=r.RG16UI),B===r.UNSIGNED_INT&&(q=r.RG32UI),B===r.BYTE&&(q=r.RG8I),B===r.SHORT&&(q=r.RG16I),B===r.INT&&(q=r.RG32I)),S===r.RGB_INTEGER&&(B===r.UNSIGNED_BYTE&&(q=r.RGB8UI),B===r.UNSIGNED_SHORT&&(q=r.RGB16UI),B===r.UNSIGNED_INT&&(q=r.RGB32UI),B===r.BYTE&&(q=r.RGB8I),B===r.SHORT&&(q=r.RGB16I),B===r.INT&&(q=r.RGB32I)),S===r.RGBA_INTEGER&&(B===r.UNSIGNED_BYTE&&(q=r.RGBA8UI),B===r.UNSIGNED_SHORT&&(q=r.RGBA16UI),B===r.UNSIGNED_INT&&(q=r.RGBA32UI),B===r.BYTE&&(q=r.RGBA8I),B===r.SHORT&&(q=r.RGBA16I),B===r.INT&&(q=r.RGBA32I)),S===r.RGB&&B===r.UNSIGNED_INT_5_9_9_9_REV&&(q=r.RGB9_E5),S===r.RGBA){const xe=Q?Er:He.getTransfer(Z);B===r.FLOAT&&(q=r.RGBA32F),B===r.HALF_FLOAT&&(q=r.RGBA16F),B===r.UNSIGNED_BYTE&&(q=xe===it?r.SRGB8_ALPHA8:r.RGBA8),B===r.UNSIGNED_SHORT_4_4_4_4&&(q=r.RGBA4),B===r.UNSIGNED_SHORT_5_5_5_1&&(q=r.RGB5_A1)}return(q===r.R16F||q===r.R32F||q===r.RG16F||q===r.RG32F||q===r.RGBA16F||q===r.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function x(A,S){let B;return A?S===null||S===mi||S===ji?B=r.DEPTH24_STENCIL8:S===un?B=r.DEPTH32F_STENCIL8:S===Ts&&(B=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===mi||S===ji?B=r.DEPTH_COMPONENT24:S===un?B=r.DEPTH_COMPONENT32F:S===Ts&&(B=r.DEPTH_COMPONENT16),B}function C(A,S){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==kt&&A.minFilter!==jt?Math.log2(Math.max(S.width,S.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?S.mipmaps.length:1}function R(A){const S=A.target;S.removeEventListener("dispose",R),P(S),S.isVideoTexture&&h.delete(S)}function w(A){const S=A.target;S.removeEventListener("dispose",w),v(S)}function P(A){const S=n.get(A);if(S.__webglInit===void 0)return;const B=A.source,Z=d.get(B);if(Z){const Q=Z[S.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&E(A),Object.keys(Z).length===0&&d.delete(B)}n.remove(A)}function E(A){const S=n.get(A);r.deleteTexture(S.__webglTexture);const B=A.source,Z=d.get(B);delete Z[S.__cacheKey],o.memory.textures--}function v(A){const S=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(S.__webglFramebuffer[Z]))for(let Q=0;Q<S.__webglFramebuffer[Z].length;Q++)r.deleteFramebuffer(S.__webglFramebuffer[Z][Q]);else r.deleteFramebuffer(S.__webglFramebuffer[Z]);S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer[Z])}else{if(Array.isArray(S.__webglFramebuffer))for(let Z=0;Z<S.__webglFramebuffer.length;Z++)r.deleteFramebuffer(S.__webglFramebuffer[Z]);else r.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&r.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Z=0;Z<S.__webglColorRenderbuffer.length;Z++)S.__webglColorRenderbuffer[Z]&&r.deleteRenderbuffer(S.__webglColorRenderbuffer[Z]);S.__webglDepthRenderbuffer&&r.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const B=A.textures;for(let Z=0,Q=B.length;Z<Q;Z++){const q=n.get(B[Z]);q.__webglTexture&&(r.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(B[Z])}n.remove(A)}let I=0;function k(){I=0}function F(){const A=I;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),I+=1,A}function V(A){const S=[];return S.push(A.wrapS),S.push(A.wrapT),S.push(A.wrapR||0),S.push(A.magFilter),S.push(A.minFilter),S.push(A.anisotropy),S.push(A.internalFormat),S.push(A.format),S.push(A.type),S.push(A.generateMipmaps),S.push(A.premultiplyAlpha),S.push(A.flipY),S.push(A.unpackAlignment),S.push(A.colorSpace),S.join()}function W(A,S){const B=n.get(A);if(A.isVideoTexture&&Me(A),A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){const Z=A.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(B,A,S);return}}t.bindTexture(r.TEXTURE_2D,B.__webglTexture,r.TEXTURE0+S)}function z(A,S){const B=n.get(A);if(A.version>0&&B.__version!==A.version){Y(B,A,S);return}t.bindTexture(r.TEXTURE_2D_ARRAY,B.__webglTexture,r.TEXTURE0+S)}function j(A,S){const B=n.get(A);if(A.version>0&&B.__version!==A.version){Y(B,A,S);return}t.bindTexture(r.TEXTURE_3D,B.__webglTexture,r.TEXTURE0+S)}function O(A,S){const B=n.get(A);if(A.version>0&&B.__version!==A.version){ie(B,A,S);return}t.bindTexture(r.TEXTURE_CUBE_MAP,B.__webglTexture,r.TEXTURE0+S)}const K={[en]:r.REPEAT,[Xn]:r.CLAMP_TO_EDGE,[Mr]:r.MIRRORED_REPEAT},ne={[kt]:r.NEAREST,[Pl]:r.NEAREST_MIPMAP_NEAREST,[xs]:r.NEAREST_MIPMAP_LINEAR,[jt]:r.LINEAR,[fr]:r.LINEAR_MIPMAP_NEAREST,[Cn]:r.LINEAR_MIPMAP_LINEAR},re={[ou]:r.NEVER,[du]:r.ALWAYS,[au]:r.LESS,[Vl]:r.LEQUAL,[cu]:r.EQUAL,[uu]:r.GEQUAL,[lu]:r.GREATER,[hu]:r.NOTEQUAL};function ve(A,S){if(S.type===un&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===jt||S.magFilter===fr||S.magFilter===xs||S.magFilter===Cn||S.minFilter===jt||S.minFilter===fr||S.minFilter===xs||S.minFilter===Cn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(A,r.TEXTURE_WRAP_S,K[S.wrapS]),r.texParameteri(A,r.TEXTURE_WRAP_T,K[S.wrapT]),(A===r.TEXTURE_3D||A===r.TEXTURE_2D_ARRAY)&&r.texParameteri(A,r.TEXTURE_WRAP_R,K[S.wrapR]),r.texParameteri(A,r.TEXTURE_MAG_FILTER,ne[S.magFilter]),r.texParameteri(A,r.TEXTURE_MIN_FILTER,ne[S.minFilter]),S.compareFunction&&(r.texParameteri(A,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(A,r.TEXTURE_COMPARE_FUNC,re[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===kt||S.minFilter!==xs&&S.minFilter!==Cn||S.type===un&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");r.texParameterf(A,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function Be(A,S){let B=!1;A.__webglInit===void 0&&(A.__webglInit=!0,S.addEventListener("dispose",R));const Z=S.source;let Q=d.get(Z);Q===void 0&&(Q={},d.set(Z,Q));const q=V(S);if(q!==A.__cacheKey){Q[q]===void 0&&(Q[q]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,B=!0),Q[q].usedTimes++;const xe=Q[A.__cacheKey];xe!==void 0&&(Q[A.__cacheKey].usedTimes--,xe.usedTimes===0&&E(S)),A.__cacheKey=q,A.__webglTexture=Q[q].texture}return B}function Y(A,S,B){let Z=r.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Z=r.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Z=r.TEXTURE_3D);const Q=Be(A,S),q=S.source;t.bindTexture(Z,A.__webglTexture,r.TEXTURE0+B);const xe=n.get(q);if(q.version!==xe.__version||Q===!0){t.activeTexture(r.TEXTURE0+B);const le=He.getPrimaries(He.workingColorSpace),fe=S.colorSpace===Wn?null:He.getPrimaries(S.colorSpace),Ye=S.colorSpace===Wn||le===fe?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);let ee=_(S.image,!1,i.maxTextureSize);ee=lt(S,ee);const pe=s.convert(S.format,S.colorSpace),we=s.convert(S.type);let Re=y(S.internalFormat,pe,we,S.colorSpace,S.isVideoTexture);ve(Z,S);let me;const Xe=S.mipmaps,Ne=S.isVideoTexture!==!0,at=xe.__version===void 0||Q===!0,D=q.dataReady,ae=C(S,ee);if(S.isDepthTexture)Re=x(S.format===qi,S.type),at&&(Ne?t.texStorage2D(r.TEXTURE_2D,1,Re,ee.width,ee.height):t.texImage2D(r.TEXTURE_2D,0,Re,ee.width,ee.height,0,pe,we,null));else if(S.isDataTexture)if(Xe.length>0){Ne&&at&&t.texStorage2D(r.TEXTURE_2D,ae,Re,Xe[0].width,Xe[0].height);for(let X=0,$=Xe.length;X<$;X++)me=Xe[X],Ne?D&&t.texSubImage2D(r.TEXTURE_2D,X,0,0,me.width,me.height,pe,we,me.data):t.texImage2D(r.TEXTURE_2D,X,Re,me.width,me.height,0,pe,we,me.data);S.generateMipmaps=!1}else Ne?(at&&t.texStorage2D(r.TEXTURE_2D,ae,Re,ee.width,ee.height),D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ee.width,ee.height,pe,we,ee.data)):t.texImage2D(r.TEXTURE_2D,0,Re,ee.width,ee.height,0,pe,we,ee.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ne&&at&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ae,Re,Xe[0].width,Xe[0].height,ee.depth);for(let X=0,$=Xe.length;X<$;X++)if(me=Xe[X],S.format!==tn)if(pe!==null)if(Ne){if(D)if(S.layerUpdates.size>0){const ue=zc(me.width,me.height,S.format,S.type);for(const he of S.layerUpdates){const De=me.data.subarray(he*ue/me.data.BYTES_PER_ELEMENT,(he+1)*ue/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,he,me.width,me.height,1,pe,De)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,0,me.width,me.height,ee.depth,pe,me.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,X,Re,me.width,me.height,ee.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?D&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,0,me.width,me.height,ee.depth,pe,we,me.data):t.texImage3D(r.TEXTURE_2D_ARRAY,X,Re,me.width,me.height,ee.depth,0,pe,we,me.data)}else{Ne&&at&&t.texStorage2D(r.TEXTURE_2D,ae,Re,Xe[0].width,Xe[0].height);for(let X=0,$=Xe.length;X<$;X++)me=Xe[X],S.format!==tn?pe!==null?Ne?D&&t.compressedTexSubImage2D(r.TEXTURE_2D,X,0,0,me.width,me.height,pe,me.data):t.compressedTexImage2D(r.TEXTURE_2D,X,Re,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?D&&t.texSubImage2D(r.TEXTURE_2D,X,0,0,me.width,me.height,pe,we,me.data):t.texImage2D(r.TEXTURE_2D,X,Re,me.width,me.height,0,pe,we,me.data)}else if(S.isDataArrayTexture)if(Ne){if(at&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ae,Re,ee.width,ee.height,ee.depth),D)if(S.layerUpdates.size>0){const X=zc(ee.width,ee.height,S.format,S.type);for(const $ of S.layerUpdates){const ue=ee.data.subarray($*X/ee.data.BYTES_PER_ELEMENT,($+1)*X/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,$,ee.width,ee.height,1,pe,we,ue)}S.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,pe,we,ee.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Re,ee.width,ee.height,ee.depth,0,pe,we,ee.data);else if(S.isData3DTexture)Ne?(at&&t.texStorage3D(r.TEXTURE_3D,ae,Re,ee.width,ee.height,ee.depth),D&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,pe,we,ee.data)):t.texImage3D(r.TEXTURE_3D,0,Re,ee.width,ee.height,ee.depth,0,pe,we,ee.data);else if(S.isFramebufferTexture){if(at)if(Ne)t.texStorage2D(r.TEXTURE_2D,ae,Re,ee.width,ee.height);else{let X=ee.width,$=ee.height;for(let ue=0;ue<ae;ue++)t.texImage2D(r.TEXTURE_2D,ue,Re,X,$,0,pe,we,null),X>>=1,$>>=1}}else if(Xe.length>0){if(Ne&&at){const X=ye(Xe[0]);t.texStorage2D(r.TEXTURE_2D,ae,Re,X.width,X.height)}for(let X=0,$=Xe.length;X<$;X++)me=Xe[X],Ne?D&&t.texSubImage2D(r.TEXTURE_2D,X,0,0,pe,we,me):t.texImage2D(r.TEXTURE_2D,X,Re,pe,we,me);S.generateMipmaps=!1}else if(Ne){if(at){const X=ye(ee);t.texStorage2D(r.TEXTURE_2D,ae,Re,X.width,X.height)}D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,pe,we,ee)}else t.texImage2D(r.TEXTURE_2D,0,Re,pe,we,ee);m(S)&&f(Z),xe.__version=q.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function ie(A,S,B){if(S.image.length!==6)return;const Z=Be(A,S),Q=S.source;t.bindTexture(r.TEXTURE_CUBE_MAP,A.__webglTexture,r.TEXTURE0+B);const q=n.get(Q);if(Q.version!==q.__version||Z===!0){t.activeTexture(r.TEXTURE0+B);const xe=He.getPrimaries(He.workingColorSpace),le=S.colorSpace===Wn?null:He.getPrimaries(S.colorSpace),fe=S.colorSpace===Wn||xe===le?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Ye=S.isCompressedTexture||S.image[0].isCompressedTexture,ee=S.image[0]&&S.image[0].isDataTexture,pe=[];for(let $=0;$<6;$++)!Ye&&!ee?pe[$]=_(S.image[$],!0,i.maxCubemapSize):pe[$]=ee?S.image[$].image:S.image[$],pe[$]=lt(S,pe[$]);const we=pe[0],Re=s.convert(S.format,S.colorSpace),me=s.convert(S.type),Xe=y(S.internalFormat,Re,me,S.colorSpace),Ne=S.isVideoTexture!==!0,at=q.__version===void 0||Z===!0,D=Q.dataReady;let ae=C(S,we);ve(r.TEXTURE_CUBE_MAP,S);let X;if(Ye){Ne&&at&&t.texStorage2D(r.TEXTURE_CUBE_MAP,ae,Xe,we.width,we.height);for(let $=0;$<6;$++){X=pe[$].mipmaps;for(let ue=0;ue<X.length;ue++){const he=X[ue];S.format!==tn?Re!==null?Ne?D&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue,0,0,he.width,he.height,Re,he.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue,Xe,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue,0,0,he.width,he.height,Re,me,he.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue,Xe,he.width,he.height,0,Re,me,he.data)}}}else{if(X=S.mipmaps,Ne&&at){X.length>0&&ae++;const $=ye(pe[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,ae,Xe,$.width,$.height)}for(let $=0;$<6;$++)if(ee){Ne?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,pe[$].width,pe[$].height,Re,me,pe[$].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Xe,pe[$].width,pe[$].height,0,Re,me,pe[$].data);for(let ue=0;ue<X.length;ue++){const De=X[ue].image[$].image;Ne?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue+1,0,0,De.width,De.height,Re,me,De.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue+1,Xe,De.width,De.height,0,Re,me,De.data)}}else{Ne?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Re,me,pe[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Xe,Re,me,pe[$]);for(let ue=0;ue<X.length;ue++){const he=X[ue];Ne?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue+1,0,0,Re,me,he.image[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,ue+1,Xe,Re,me,he.image[$])}}}m(S)&&f(r.TEXTURE_CUBE_MAP),q.__version=Q.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function _e(A,S,B,Z,Q,q){const xe=s.convert(B.format,B.colorSpace),le=s.convert(B.type),fe=y(B.internalFormat,xe,le,B.colorSpace),Ye=n.get(S),ee=n.get(B);if(ee.__renderTarget=S,!Ye.__hasExternalTextures){const pe=Math.max(1,S.width>>q),we=Math.max(1,S.height>>q);Q===r.TEXTURE_3D||Q===r.TEXTURE_2D_ARRAY?t.texImage3D(Q,q,fe,pe,we,S.depth,0,xe,le,null):t.texImage2D(Q,q,fe,pe,we,0,xe,le,null)}t.bindFramebuffer(r.FRAMEBUFFER,A),We(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Z,Q,ee.__webglTexture,0,Ge(S)):(Q===r.TEXTURE_2D||Q>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Z,Q,ee.__webglTexture,q),t.bindFramebuffer(r.FRAMEBUFFER,null)}function oe(A,S,B){if(r.bindRenderbuffer(r.RENDERBUFFER,A),S.depthBuffer){const Z=S.depthTexture,Q=Z&&Z.isDepthTexture?Z.type:null,q=x(S.stencilBuffer,Q),xe=S.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,le=Ge(S);We(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,le,q,S.width,S.height):B?r.renderbufferStorageMultisample(r.RENDERBUFFER,le,q,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,q,S.width,S.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,xe,r.RENDERBUFFER,A)}else{const Z=S.textures;for(let Q=0;Q<Z.length;Q++){const q=Z[Q],xe=s.convert(q.format,q.colorSpace),le=s.convert(q.type),fe=y(q.internalFormat,xe,le,q.colorSpace),Ye=Ge(S);B&&We(S)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ye,fe,S.width,S.height):We(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ye,fe,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,fe,S.width,S.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Se(A,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,A),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(S.depthTexture);Z.__renderTarget=S,(!Z.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),W(S.depthTexture,0);const Q=Z.__webglTexture,q=Ge(S);if(S.depthTexture.format===Hi)We(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0);else if(S.depthTexture.format===qi)We(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function ke(A){const S=n.get(A),B=A.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==A.depthTexture){const Z=A.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Z){const Q=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Z.removeEventListener("dispose",Q)};Z.addEventListener("dispose",Q),S.__depthDisposeCallback=Q}S.__boundDepthTexture=Z}if(A.depthTexture&&!S.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");Se(S.__webglFramebuffer,A)}else if(B){S.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer[Z]),S.__webglDepthbuffer[Z]===void 0)S.__webglDepthbuffer[Z]=r.createRenderbuffer(),oe(S.__webglDepthbuffer[Z],A,!1);else{const Q=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,q=S.__webglDepthbuffer[Z];r.bindRenderbuffer(r.RENDERBUFFER,q),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,q)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=r.createRenderbuffer(),oe(S.__webglDepthbuffer,A,!1);else{const Z=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Q=S.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Q),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,Q)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function Ae(A,S,B){const Z=n.get(A);S!==void 0&&_e(Z.__webglFramebuffer,A,A.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),B!==void 0&&ke(A)}function pt(A){const S=A.texture,B=n.get(A),Z=n.get(S);A.addEventListener("dispose",w);const Q=A.textures,q=A.isWebGLCubeRenderTarget===!0,xe=Q.length>1;if(xe||(Z.__webglTexture===void 0&&(Z.__webglTexture=r.createTexture()),Z.__version=S.version,o.memory.textures++),q){B.__webglFramebuffer=[];for(let le=0;le<6;le++)if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer[le]=[];for(let fe=0;fe<S.mipmaps.length;fe++)B.__webglFramebuffer[le][fe]=r.createFramebuffer()}else B.__webglFramebuffer[le]=r.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer=[];for(let le=0;le<S.mipmaps.length;le++)B.__webglFramebuffer[le]=r.createFramebuffer()}else B.__webglFramebuffer=r.createFramebuffer();if(xe)for(let le=0,fe=Q.length;le<fe;le++){const Ye=n.get(Q[le]);Ye.__webglTexture===void 0&&(Ye.__webglTexture=r.createTexture(),o.memory.textures++)}if(A.samples>0&&We(A)===!1){B.__webglMultisampledFramebuffer=r.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let le=0;le<Q.length;le++){const fe=Q[le];B.__webglColorRenderbuffer[le]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,B.__webglColorRenderbuffer[le]);const Ye=s.convert(fe.format,fe.colorSpace),ee=s.convert(fe.type),pe=y(fe.internalFormat,Ye,ee,fe.colorSpace,A.isXRRenderTarget===!0),we=Ge(A);r.renderbufferStorageMultisample(r.RENDERBUFFER,we,pe,A.width,A.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.RENDERBUFFER,B.__webglColorRenderbuffer[le])}r.bindRenderbuffer(r.RENDERBUFFER,null),A.depthBuffer&&(B.__webglDepthRenderbuffer=r.createRenderbuffer(),oe(B.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(q){t.bindTexture(r.TEXTURE_CUBE_MAP,Z.__webglTexture),ve(r.TEXTURE_CUBE_MAP,S);for(let le=0;le<6;le++)if(S.mipmaps&&S.mipmaps.length>0)for(let fe=0;fe<S.mipmaps.length;fe++)_e(B.__webglFramebuffer[le][fe],A,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+le,fe);else _e(B.__webglFramebuffer[le],A,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);m(S)&&f(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(xe){for(let le=0,fe=Q.length;le<fe;le++){const Ye=Q[le],ee=n.get(Ye);t.bindTexture(r.TEXTURE_2D,ee.__webglTexture),ve(r.TEXTURE_2D,Ye),_e(B.__webglFramebuffer,A,Ye,r.COLOR_ATTACHMENT0+le,r.TEXTURE_2D,0),m(Ye)&&f(r.TEXTURE_2D)}t.unbindTexture()}else{let le=r.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(le=A.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(le,Z.__webglTexture),ve(le,S),S.mipmaps&&S.mipmaps.length>0)for(let fe=0;fe<S.mipmaps.length;fe++)_e(B.__webglFramebuffer[fe],A,S,r.COLOR_ATTACHMENT0,le,fe);else _e(B.__webglFramebuffer,A,S,r.COLOR_ATTACHMENT0,le,0);m(S)&&f(le),t.unbindTexture()}A.depthBuffer&&ke(A)}function ct(A){const S=A.textures;for(let B=0,Z=S.length;B<Z;B++){const Q=S[B];if(m(Q)){const q=M(A),xe=n.get(Q).__webglTexture;t.bindTexture(q,xe),f(q),t.unbindTexture()}}}const Ve=[],L=[];function qt(A){if(A.samples>0){if(We(A)===!1){const S=A.textures,B=A.width,Z=A.height;let Q=r.COLOR_BUFFER_BIT;const q=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,xe=n.get(A),le=S.length>1;if(le)for(let fe=0;fe<S.length;fe++)t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,xe.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,xe.__webglFramebuffer);for(let fe=0;fe<S.length;fe++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Q|=r.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Q|=r.STENCIL_BUFFER_BIT)),le){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,xe.__webglColorRenderbuffer[fe]);const Ye=n.get(S[fe]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ye,0)}r.blitFramebuffer(0,0,B,Z,0,0,B,Z,Q,r.NEAREST),c===!0&&(Ve.length=0,L.length=0,Ve.push(r.COLOR_ATTACHMENT0+fe),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Ve.push(q),L.push(q),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,L)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ve))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),le)for(let fe=0;fe<S.length;fe++){t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,xe.__webglColorRenderbuffer[fe]);const Ye=n.get(S[fe]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.TEXTURE_2D,Ye,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,xe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const S=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[S])}}}function Ge(A){return Math.min(i.maxSamples,A.samples)}function We(A){const S=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Me(A){const S=o.render.frame;h.get(A)!==S&&(h.set(A,S),A.update())}function lt(A,S){const B=A.colorSpace,Z=A.format,Q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||B!==Ut&&B!==Wn&&(He.getTransfer(B)===it?(Z!==tn||Q!==Dn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),S}function ye(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=k,this.setTexture2D=W,this.setTexture2DArray=z,this.setTexture3D=j,this.setTextureCube=O,this.rebindTextures=Ae,this.setupRenderTarget=pt,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=qt,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=We}function b_(r,e){function t(n,i=Wn){let s;const o=He.getTransfer(i);if(n===Dn)return r.UNSIGNED_BYTE;if(n===_a)return r.UNSIGNED_SHORT_4_4_4_4;if(n===xa)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Dl)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Il)return r.BYTE;if(n===Ll)return r.SHORT;if(n===Ts)return r.UNSIGNED_SHORT;if(n===ga)return r.INT;if(n===mi)return r.UNSIGNED_INT;if(n===un)return r.FLOAT;if(n===Cs)return r.HALF_FLOAT;if(n===Ul)return r.ALPHA;if(n===Nl)return r.RGB;if(n===tn)return r.RGBA;if(n===Fl)return r.LUMINANCE;if(n===Ol)return r.LUMINANCE_ALPHA;if(n===Hi)return r.DEPTH_COMPONENT;if(n===qi)return r.DEPTH_STENCIL;if(n===va)return r.RED;if(n===ya)return r.RED_INTEGER;if(n===Bl)return r.RG;if(n===Ma)return r.RG_INTEGER;if(n===Sa)return r.RGBA_INTEGER;if(n===pr||n===mr||n===gr||n===_r)if(o===it)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===pr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===_r)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===pr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===mr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===_r)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Do||n===Uo||n===No||n===Fo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Do)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Uo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===No)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Fo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Oo||n===Bo||n===ko)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Oo||n===Bo)return o===it?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ko)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===zo||n===Ho||n===Vo||n===Go||n===Wo||n===Xo||n===Yo||n===jo||n===qo||n===Ko||n===Zo||n===$o||n===Qo||n===Jo)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===zo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ho)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Vo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Go)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Wo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Xo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Yo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===jo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===qo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ko)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Zo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===$o)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Qo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Jo)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xr||n===ea||n===ta)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===xr)return o===it?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ea)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ta)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===kl||n===na||n===ia||n===sa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===xr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===na)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ia)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===sa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ji?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const T_=`
void main() {
