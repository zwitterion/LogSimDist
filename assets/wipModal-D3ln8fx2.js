...
`].filter(Ms).join(`
`)),o=xa(o),o=dl(o,t),o=fl(o,t),a=xa(a),a=dl(a,t),a=fl(a,t),o=pl(o),a=pl(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+f);const v=M+m+o,x=M+f+a,P=ll(i,i.VERTEX_SHADER,v),R=ll(i,i.FRAGMENT_SHADER,x);i.attachShader(_,P),i.attachShader(_,R),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(I){if(r.debug.checkShaderErrors){const B=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(P).trim(),k=i.getShaderInfoLog(R).trim();let X=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,P,R);else{const $=ul(i,P,"vertex"),F=ul(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function C_(r,e,t){let n=new Ba;const i=new Ae,s=new Ae,o=new Ze,a=new bd({depthPacking:gu}),c=new Td,l={},h=t.maxTextureSize,u={[Fn]:Ht,[Ht]:Fn,[Ut]:Ut},d=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ae},radius:{value:4}},vertexShader:A_,fragmentShader:R_}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new vt;g.setAttribute("position",new ut(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new te(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Nl;let f=this.type;this.render=function(R,A,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const E=r.getRenderTarget(),y=r.getActiveCubeFace(),I=r.getActiveMipmapLevel(),B=r.state;B.setBlending($n),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const O=f!==Pn&&this.type===Pn,k=f===Pn&&this.type!==Pn;for(let X=0,H=R.length;X<H;X++){const $=R[X],F=$.shadow;if(F===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;i.copy(F.mapSize);const q=F.getFrameExtents();if(i.multiply(q),s.copy(F.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/q.x),i.x=s.x*q.x,F.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/q.y),i.y=s.y*q.y,F.mapSize.y=s.y)),F.map===null||O===!0||k===!0){const ae=this.type!==Pn?{minFilter:Gt,magFilter:Gt}:{};F.map!==null&&F.map.dispose(),F.map=new xi(i.x,i.y,ae),F.map.texture.name=$.name+".shadowMap",F.camera.updateProjectionMatrix()}r.setRenderTarget(F.map),r.clear();const se=F.getViewportCount();for(let ae=0;ae<se;ae++){const me=F.getViewport(ae);o.set(s.x*me.x,s.y*me.y,s.x*me.z,s.y*me.w),B.viewport(o),F.updateMatrices($,ae),n=F.getFrustum(),x(A,C,F.camera,$,this.type)}F.isPointLightShadow!==!0&&this.type===Pn&&M(F,C),F.needsUpdate=!1}f=this.type,m.needsUpdate=!1,r.setRenderTarget(E,y,I)};function M(R,A){const C=e.update(_);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new xi(i.x,i.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,r.setRenderTarget(R.mapPass),r.clear(),r.renderBufferDirect(A,null,C,d,_,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,r.setRenderTarget(R.map),r.clear(),r.renderBufferDirect(A,null,C,p,_,null)}function v(R,A,C,E){let y=null;const I=C.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(I!==void 0)y=I;else if(y=C.isPointLight===!0?c:a,r.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const B=y.uuid,O=A.uuid;let k=l[B];k===void 0&&(k={},l[B]=k);let X=k[O];X===void 0&&(X=y.clone(),k[O]=X,A.addEventListener("dispose",P)),y=X}if(y.visible=A.visible,y.wireframe=A.wireframe,E===Pn?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:u[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,C.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const B=r.properties.get(y);B.light=C}return y}function x(R,A,C,E,y){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===Pn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,R.matrixWorld);const O=e.update(R),k=R.material;if(Array.isArray(k)){const X=O.groups;for(let H=0,$=X.length;H<$;H++){const F=X[H],q=k[F.materialIndex];if(q&&q.visible){const se=v(R,q,E,y);R.onBeforeShadow(r,R,A,C,O,se,F),r.renderBufferDirect(C,null,O,se,R,F),R.onAfterShadow(r,R,A,C,O,se,F)}}}else if(k.visible){const X=v(R,k,E,y);R.onBeforeShadow(r,R,A,C,O,X,null),r.renderBufferDirect(C,null,O,X,R,null),R.onAfterShadow(r,R,A,C,O,X,null)}}const B=R.children;for(let O=0,k=B.length;O<k;O++)x(B[O],A,C,E,y)}function P(R){R.target.removeEventListener("dispose",P);for(const C in l){const E=l[C],y=R.target.uuid;y in E&&(E[y].dispose(),delete E[y])}}}const P_={[Co]:Po,[Io]:Uo,[Lo]:No,[qi]:Do,[Po]:Co,[Uo]:Io,[No]:Lo,[Do]:qi};function I_(r,e){function t(){let D=!1;const le=new Ze;let Y=null;const J=new Ze(0,0,0,0);return{setMask:function(fe){Y!==fe&&!D&&(r.colorMask(fe,fe,fe,fe),Y=fe)},setLocked:function(fe){D=fe},setClear:function(fe,de,Ne,gt,Ct){Ct===!0&&(fe*=gt,de*=gt,Ne*=gt),le.set(fe,de,Ne,gt),J.equals(le)===!1&&(r.clearColor(fe,de,Ne,gt),J.copy(le))},reset:function(){D=!1,Y=null,J.set(-1,0,0,0)}}}function n(){let D=!1,le=!1,Y=null,J=null,fe=null;return{setReversed:function(de){if(le!==de){const Ne=e.get("EXT_clip_control");le?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT);const gt=fe;fe=null,this.setClear(gt)}le=de},getReversed:function(){return le},setTest:function(de){de?K(r.DEPTH_TEST):oe(r.DEPTH_TEST)},setMask:function(de){Y!==de&&!D&&(r.depthMask(de),Y=de)},setFunc:function(de){if(le&&(de=P_[de]),J!==de){switch(de){case Co:r.depthFunc(r.NEVER);break;case Po:r.depthFunc(r.ALWAYS);break;case Io:r.depthFunc(r.LESS);break;case qi:r.depthFunc(r.LEQUAL);break;case Lo:r.depthFunc(r.EQUAL);break;case Do:r.depthFunc(r.GEQUAL);break;case Uo:r.depthFunc(r.GREATER);break;case No:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}J=de}},setLocked:function(de){D=de},setClear:function(de){fe!==de&&(le&&(de=1-de),r.clearDepth(de),fe=de)},reset:function(){D=!1,Y=null,J=null,fe=null,le=!1}}}function i(){let D=!1,le=null,Y=null,J=null,fe=null,de=null,Ne=null,gt=null,Ct=null;return{setTest:function(et){D||(et?K(r.STENCIL_TEST):oe(r.STENCIL_TEST))},setMask:function(et){le!==et&&!D&&(r.stencilMask(et),le=et)},setFunc:function(et,on,En){(Y!==et||J!==on||fe!==En)&&(r.stencilFunc(et,on,En),Y=et,J=on,fe=En)},setOp:function(et,on,En){(de!==et||Ne!==on||gt!==En)&&(r.stencilOp(et,on,En),de=et,Ne=on,gt=En)},setLocked:function(et){D=et},setClear:function(et){Ct!==et&&(r.clearStencil(et),Ct=et)},reset:function(){D=!1,le=null,Y=null,J=null,fe=null,de=null,Ne=null,gt=null,Ct=null}}}const s=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,M=null,v=null,x=null,P=null,R=null,A=new Ie(0,0,0),C=0,E=!1,y=null,I=null,B=null,O=null,k=null;const X=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,$=0;const F=r.getParameter(r.VERSION);F.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(F)[1]),H=$>=1):F.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),H=$>=2);let q=null,se={};const ae=r.getParameter(r.SCISSOR_BOX),me=r.getParameter(r.VIEWPORT),Le=new Ze().fromArray(ae),j=new Ze().fromArray(me);function G(D,le,Y,J){const fe=new Uint8Array(4),de=r.createTexture();r.bindTexture(D,de),r.texParameteri(D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(D,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ne=0;Ne<Y;Ne++)D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY?r.texImage3D(le,0,r.RGBA,1,1,J,0,r.RGBA,r.UNSIGNED_BYTE,fe):r.texImage2D(le+Ne,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,fe);return de}const ee={};ee[r.TEXTURE_2D]=G(r.TEXTURE_2D,r.TEXTURE_2D,1),ee[r.TEXTURE_CUBE_MAP]=G(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ee[r.TEXTURE_2D_ARRAY]=G(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ee[r.TEXTURE_3D]=G(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),K(r.DEPTH_TEST),o.setFunc(qi),We(!1),Xe(tc),K(r.CULL_FACE),L($n);function K(D){h[D]!==!0&&(r.enable(D),h[D]=!0)}function oe(D){h[D]!==!1&&(r.disable(D),h[D]=!1)}function Me(D,le){return u[D]!==le?(r.bindFramebuffer(D,le),u[D]=le,D===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=le),D===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=le),!0):!1}function pe(D,le){let Y=p,J=!1;if(D){Y=d.get(le),Y===void 0&&(Y=[],d.set(le,Y));const fe=D.textures;if(Y.length!==fe.length||Y[0]!==r.COLOR_ATTACHMENT0){for(let de=0,Ne=fe.length;de<Ne;de++)Y[de]=r.COLOR_ATTACHMENT0+de;Y.length=fe.length,J=!0}}else Y[0]!==r.BACK&&(Y[0]=r.BACK,J=!0);J&&r.drawBuffers(Y)}function it(D){return g!==D?(r.useProgram(D),g=D,!0):!1}const at={[pi]:r.FUNC_ADD,[Oh]:r.FUNC_SUBTRACT,[Bh]:r.FUNC_REVERSE_SUBTRACT};at[kh]=r.MIN,at[zh]=r.MAX;const He={[Hh]:r.ZERO,[Gh]:r.ONE,[Vh]:r.SRC_COLOR,[Ao]:r.SRC_ALPHA,[Kh]:r.SRC_ALPHA_SATURATE,[jh]:r.DST_COLOR,[Xh]:r.DST_ALPHA,[Wh]:r.ONE_MINUS_SRC_COLOR,[Ro]:r.ONE_MINUS_SRC_ALPHA,[qh]:r.ONE_MINUS_DST_COLOR,[Yh]:r.ONE_MINUS_DST_ALPHA,[Zh]:r.CONSTANT_COLOR,[$h]:r.ONE_MINUS_CONSTANT_COLOR,[Qh]:r.CONSTANT_ALPHA,[Jh]:r.ONE_MINUS_CONSTANT_ALPHA};function L(D,le,Y,J,fe,de,Ne,gt,Ct,et){if(D===$n){_===!0&&(oe(r.BLEND),_=!1);return}if(_===!1&&(K(r.BLEND),_=!0),D!==Fh){if(D!==m||et!==E){if((f!==pi||x!==pi)&&(r.blendEquation(r.FUNC_ADD),f=pi,x=pi),et)switch(D){case Wi:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case nc:r.blendFunc(r.ONE,r.ONE);break;case ic:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sc:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Wi:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case nc:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case ic:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sc:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}M=null,v=null,P=null,R=null,A.set(0,0,0),C=0,m=D,E=et}return}fe=fe||le,de=de||Y,Ne=Ne||J,(le!==f||fe!==x)&&(r.blendEquationSeparate(at[le],at[fe]),f=le,x=fe),(Y!==M||J!==v||de!==P||Ne!==R)&&(r.blendFuncSeparate(He[Y],He[J],He[de],He[Ne]),M=Y,v=J,P=de,R=Ne),(gt.equals(A)===!1||Ct!==C)&&(r.blendColor(gt.r,gt.g,gt.b,Ct),A.copy(gt),C=Ct),m=D,E=!1}function Zt(D,le){D.side===Ut?oe(r.CULL_FACE):K(r.CULL_FACE);let Y=D.side===Ht;le&&(Y=!Y),We(Y),D.blending===Wi&&D.transparent===!1?L($n):L(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),s.setMask(D.colorWrite);const J=D.stencilWrite;a.setTest(J),J&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ht(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?K(r.SAMPLE_ALPHA_TO_COVERAGE):oe(r.SAMPLE_ALPHA_TO_COVERAGE)}function We(D){y!==D&&(D?r.frontFace(r.CW):r.frontFace(r.CCW),y=D)}function Xe(D){D!==Uh?(K(r.CULL_FACE),D!==I&&(D===tc?r.cullFace(r.BACK):D===Nh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):oe(r.CULL_FACE),I=D}function be(D){D!==B&&(H&&r.lineWidth(D),B=D)}function ht(D,le,Y){D?(K(r.POLYGON_OFFSET_FILL),(O!==le||k!==Y)&&(r.polygonOffset(le,Y),O=le,k=Y)):oe(r.POLYGON_OFFSET_FILL)}function Ee(D){D?K(r.SCISSOR_TEST):oe(r.SCISSOR_TEST)}function w(D){D===void 0&&(D=r.TEXTURE0+X-1),q!==D&&(r.activeTexture(D),q=D)}function S(D,le,Y){Y===void 0&&(q===null?Y=r.TEXTURE0+X-1:Y=q);let J=se[Y];J===void 0&&(J={type:void 0,texture:void 0},se[Y]=J),(J.type!==D||J.texture!==le)&&(q!==Y&&(r.activeTexture(Y),q=Y),r.bindTexture(D,le||ee[D]),J.type=D,J.texture=le)}function z(){const D=se[q];D!==void 0&&D.type!==void 0&&(r.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Q(){try{r.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ne(){try{r.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Z(){try{r.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Se(){try{r.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ue(){try{r.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function _e(){try{r.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function je(){try{r.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function re(){try{r.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{r.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(){try{r.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ce(D){Le.equals(D)===!1&&(r.scissor(D.x,D.y,D.z,D.w),Le.copy(D))}function ve(D){j.equals(D)===!1&&(r.viewport(D.x,D.y,D.z,D.w),j.copy(D))}function Ye(D,le){let Y=l.get(le);Y===void 0&&(Y=new WeakMap,l.set(le,Y));let J=Y.get(D);J===void 0&&(J=r.getUniformBlockIndex(le,D.name),Y.set(D,J))}function Oe(D,le){const J=l.get(le).get(D);c.get(le)!==J&&(r.uniformBlockBinding(le,J,D.__bindingPointIndex),c.set(le,J))}function lt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},q=null,se={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,M=null,v=null,x=null,P=null,R=null,A=new Ie(0,0,0),C=0,E=!1,y=null,I=null,B=null,O=null,k=null,Le.set(0,0,r.canvas.width,r.canvas.height),j.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:K,disable:oe,bindFramebuffer:Me,drawBuffers:pe,useProgram:it,setBlending:L,setMaterial:Zt,setFlipSided:We,setCullFace:Xe,setLineWidth:be,setPolygonOffset:ht,setScissorTest:Ee,activeTexture:w,bindTexture:S,unbindTexture:z,compressedTexImage2D:Q,compressedTexImage3D:ne,texImage2D:xe,texImage3D:Re,updateUBOMapping:Ye,uniformBlockBinding:Oe,texStorage2D:je,texStorage3D:re,texSubImage2D:Z,texSubImage3D:Se,compressedTexSubImage2D:ue,compressedTexSubImage3D:_e,scissor:Ce,viewport:ve,reset:lt}}function L_(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ae,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,S){return p?new OffscreenCanvas(w,S):Is("canvas")}function _(w,S,z){let Q=1;const ne=Ee(w);if((ne.width>z||ne.height>z)&&(Q=z/Math.max(ne.width,ne.height)),Q<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const Z=Math.floor(Q*ne.width),Se=Math.floor(Q*ne.height);u===void 0&&(u=g(Z,Se));const ue=S?g(Z,Se):u;return ue.width=Z,ue.height=Se,ue.getContext("2d").drawImage(w,0,0,Z,Se),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+Z+"x"+Se+")."),ue}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),w;return w}function m(w){return w.generateMipmaps}function f(w){r.generateMipmap(w)}function M(w){return w.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?r.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function v(w,S,z,Q,ne=!1){if(w!==null){if(r[w]!==void 0)return r[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let Z=S;if(S===r.RED&&(z===r.FLOAT&&(Z=r.R32F),z===r.HALF_FLOAT&&(Z=r.R16F),z===r.UNSIGNED_BYTE&&(Z=r.R8)),S===r.RED_INTEGER&&(z===r.UNSIGNED_BYTE&&(Z=r.R8UI),z===r.UNSIGNED_SHORT&&(Z=r.R16UI),z===r.UNSIGNED_INT&&(Z=r.R32UI),z===r.BYTE&&(Z=r.R8I),z===r.SHORT&&(Z=r.R16I),z===r.INT&&(Z=r.R32I)),S===r.RG&&(z===r.FLOAT&&(Z=r.RG32F),z===r.HALF_FLOAT&&(Z=r.RG16F),z===r.UNSIGNED_BYTE&&(Z=r.RG8)),S===r.RG_INTEGER&&(z===r.UNSIGNED_BYTE&&(Z=r.RG8UI),z===r.UNSIGNED_SHORT&&(Z=r.RG16UI),z===r.UNSIGNED_INT&&(Z=r.RG32UI),z===r.BYTE&&(Z=r.RG8I),z===r.SHORT&&(Z=r.RG16I),z===r.INT&&(Z=r.RG32I)),S===r.RGB_INTEGER&&(z===r.UNSIGNED_BYTE&&(Z=r.RGB8UI),z===r.UNSIGNED_SHORT&&(Z=r.RGB16UI),z===r.UNSIGNED_INT&&(Z=r.RGB32UI),z===r.BYTE&&(Z=r.RGB8I),z===r.SHORT&&(Z=r.RGB16I),z===r.INT&&(Z=r.RGB32I)),S===r.RGBA_INTEGER&&(z===r.UNSIGNED_BYTE&&(Z=r.RGBA8UI),z===r.UNSIGNED_SHORT&&(Z=r.RGBA16UI),z===r.UNSIGNED_INT&&(Z=r.RGBA32UI),z===r.BYTE&&(Z=r.RGBA8I),z===r.SHORT&&(Z=r.RGBA16I),z===r.INT&&(Z=r.RGBA32I)),S===r.RGB&&z===r.UNSIGNED_INT_5_9_9_9_REV&&(Z=r.RGB9_E5),S===r.RGBA){const Se=ne?wr:Ve.getTransfer(Q);z===r.FLOAT&&(Z=r.RGBA32F),z===r.HALF_FLOAT&&(Z=r.RGBA16F),z===r.UNSIGNED_BYTE&&(Z=Se===st?r.SRGB8_ALPHA8:r.RGBA8),z===r.UNSIGNED_SHORT_4_4_4_4&&(Z=r.RGBA4),z===r.UNSIGNED_SHORT_5_5_5_1&&(Z=r.RGB5_A1)}return(Z===r.R16F||Z===r.R32F||Z===r.RG16F||Z===r.RG32F||Z===r.RGBA16F||Z===r.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function x(w,S){let z;return w?S===null||S===_i||S===$i?z=r.DEPTH24_STENCIL8:S===fn?z=r.DEPTH32F_STENCIL8:S===Rs&&(z=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===_i||S===$i?z=r.DEPTH_COMPONENT24:S===fn?z=r.DEPTH_COMPONENT32F:S===Rs&&(z=r.DEPTH_COMPONENT16),z}function P(w,S){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==Gt&&w.minFilter!==qt?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function R(w){const S=w.target;S.removeEventListener("dispose",R),C(S),S.isVideoTexture&&h.delete(S)}function A(w){const S=w.target;S.removeEventListener("dispose",A),y(S)}function C(w){const S=n.get(w);if(S.__webglInit===void 0)return;const z=w.source,Q=d.get(z);if(Q){const ne=Q[S.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&E(w),Object.keys(Q).length===0&&d.delete(z)}n.remove(w)}function E(w){const S=n.get(w);r.deleteTexture(S.__webglTexture);const z=w.source,Q=d.get(z);delete Q[S.__cacheKey],o.memory.textures--}function y(w){const S=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(S.__webglFramebuffer[Q]))for(let ne=0;ne<S.__webglFramebuffer[Q].length;ne++)r.deleteFramebuffer(S.__webglFramebuffer[Q][ne]);else r.deleteFramebuffer(S.__webglFramebuffer[Q]);S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer[Q])}else{if(Array.isArray(S.__webglFramebuffer))for(let Q=0;Q<S.__webglFramebuffer.length;Q++)r.deleteFramebuffer(S.__webglFramebuffer[Q]);else r.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&r.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Q=0;Q<S.__webglColorRenderbuffer.length;Q++)S.__webglColorRenderbuffer[Q]&&r.deleteRenderbuffer(S.__webglColorRenderbuffer[Q]);S.__webglDepthRenderbuffer&&r.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=w.textures;for(let Q=0,ne=z.length;Q<ne;Q++){const Z=n.get(z[Q]);Z.__webglTexture&&(r.deleteTexture(Z.__webglTexture),o.memory.textures--),n.remove(z[Q])}n.remove(w)}let I=0;function B(){I=0}function O(){const w=I;return w>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+i.maxTextures),I+=1,w}function k(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function X(w,S){const z=n.get(w);if(w.isVideoTexture&&be(w),w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){const Q=w.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{j(z,w,S);return}}t.bindTexture(r.TEXTURE_2D,z.__webglTexture,r.TEXTURE0+S)}function H(w,S){const z=n.get(w);if(w.version>0&&z.__version!==w.version){j(z,w,S);return}t.bindTexture(r.TEXTURE_2D_ARRAY,z.__webglTexture,r.TEXTURE0+S)}function $(w,S){const z=n.get(w);if(w.version>0&&z.__version!==w.version){j(z,w,S);return}t.bindTexture(r.TEXTURE_3D,z.__webglTexture,r.TEXTURE0+S)}function F(w,S){const z=n.get(w);if(w.version>0&&z.__version!==w.version){G(z,w,S);return}t.bindTexture(r.TEXTURE_CUBE_MAP,z.__webglTexture,r.TEXTURE0+S)}const q={[Nt]:r.REPEAT,[Kn]:r.CLAMP_TO_EDGE,[br]:r.MIRRORED_REPEAT},se={[Gt]:r.NEAREST,[kl]:r.NEAREST_MIPMAP_NEAREST,[ys]:r.NEAREST_MIPMAP_LINEAR,[qt]:r.LINEAR,[gr]:r.LINEAR_MIPMAP_NEAREST,[Ln]:r.LINEAR_MIPMAP_LINEAR},ae={[xu]:r.NEVER,[bu]:r.ALWAYS,[vu]:r.LESS,[$l]:r.LEQUAL,[yu]:r.EQUAL,[Eu]:r.GEQUAL,[Mu]:r.GREATER,[Su]:r.NOTEQUAL};function me(w,S){if(S.type===fn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===qt||S.magFilter===gr||S.magFilter===ys||S.magFilter===Ln||S.minFilter===qt||S.minFilter===gr||S.minFilter===ys||S.minFilter===Ln)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(w,r.TEXTURE_WRAP_S,q[S.wrapS]),r.texParameteri(w,r.TEXTURE_WRAP_T,q[S.wrapT]),(w===r.TEXTURE_3D||w===r.TEXTURE_2D_ARRAY)&&r.texParameteri(w,r.TEXTURE_WRAP_R,q[S.wrapR]),r.texParameteri(w,r.TEXTURE_MAG_FILTER,se[S.magFilter]),r.texParameteri(w,r.TEXTURE_MIN_FILTER,se[S.minFilter]),S.compareFunction&&(r.texParameteri(w,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(w,r.TEXTURE_COMPARE_FUNC,ae[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Gt||S.minFilter!==ys&&S.minFilter!==Ln||S.type===fn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");r.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function Le(w,S){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",R));const Q=S.source;let ne=d.get(Q);ne===void 0&&(ne={},d.set(Q,ne));const Z=k(S);if(Z!==w.__cacheKey){ne[Z]===void 0&&(ne[Z]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ne[Z].usedTimes++;const Se=ne[w.__cacheKey];Se!==void 0&&(ne[w.__cacheKey].usedTimes--,Se.usedTimes===0&&E(S)),w.__cacheKey=Z,w.__webglTexture=ne[Z].texture}return z}function j(w,S,z){let Q=r.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Q=r.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Q=r.TEXTURE_3D);const ne=Le(w,S),Z=S.source;t.bindTexture(Q,w.__webglTexture,r.TEXTURE0+z);const Se=n.get(Z);if(Z.version!==Se.__version||ne===!0){t.activeTexture(r.TEXTURE0+z);const ue=Ve.getPrimaries(Ve.workingColorSpace),_e=S.colorSpace===qn?null:Ve.getPrimaries(S.colorSpace),je=S.colorSpace===qn||ue===_e?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,je);let re=_(S.image,!1,i.maxTextureSize);re=ht(S,re);const xe=s.convert(S.format,S.colorSpace),Re=s.convert(S.type);let Ce=v(S.internalFormat,xe,Re,S.colorSpace,S.isVideoTexture);me(Q,S);let ve;const Ye=S.mipmaps,Oe=S.isVideoTexture!==!0,lt=Se.__version===void 0||ne===!0,D=Z.dataReady,le=P(S,re);if(S.isDepthTexture)Ce=x(S.format===Qi,S.type),lt&&(Oe?t.texStorage2D(r.TEXTURE_2D,1,Ce,re.width,re.height):t.texImage2D(r.TEXTURE_2D,0,Ce,re.width,re.height,0,xe,Re,null));else if(S.isDataTexture)if(Ye.length>0){Oe&&lt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,Ye[0].width,Ye[0].height);for(let Y=0,J=Ye.length;Y<J;Y++)ve=Ye[Y],Oe?D&&t.texSubImage2D(r.TEXTURE_2D,Y,0,0,ve.width,ve.height,xe,Re,ve.data):t.texImage2D(r.TEXTURE_2D,Y,Ce,ve.width,ve.height,0,xe,Re,ve.data);S.generateMipmaps=!1}else Oe?(lt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,re.width,re.height),D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,re.width,re.height,xe,Re,re.data)):t.texImage2D(r.TEXTURE_2D,0,Ce,re.width,re.height,0,xe,Re,re.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Oe&&lt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ce,Ye[0].width,Ye[0].height,re.depth);for(let Y=0,J=Ye.length;Y<J;Y++)if(ve=Ye[Y],S.format!==sn)if(xe!==null)if(Oe){if(D)if(S.layerUpdates.size>0){const fe=Kc(ve.width,ve.height,S.format,S.type);for(const de of S.layerUpdates){const Ne=ve.data.subarray(de*fe/ve.data.BYTES_PER_ELEMENT,(de+1)*fe/ve.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Y,0,0,de,ve.width,ve.height,1,xe,Ne)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Y,0,0,0,ve.width,ve.height,re.depth,xe,ve.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Y,Ce,ve.width,ve.height,re.depth,0,ve.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?D&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,Y,0,0,0,ve.width,ve.height,re.depth,xe,Re,ve.data):t.texImage3D(r.TEXTURE_2D_ARRAY,Y,Ce,ve.width,ve.height,re.depth,0,xe,Re,ve.data)}else{Oe&&lt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,Ye[0].width,Ye[0].height);for(let Y=0,J=Ye.length;Y<J;Y++)ve=Ye[Y],S.format!==sn?xe!==null?Oe?D&&t.compressedTexSubImage2D(r.TEXTURE_2D,Y,0,0,ve.width,ve.height,xe,ve.data):t.compressedTexImage2D(r.TEXTURE_2D,Y,Ce,ve.width,ve.height,0,ve.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?D&&t.texSubImage2D(r.TEXTURE_2D,Y,0,0,ve.width,ve.height,xe,Re,ve.data):t.texImage2D(r.TEXTURE_2D,Y,Ce,ve.width,ve.height,0,xe,Re,ve.data)}else if(S.isDataArrayTexture)if(Oe){if(lt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ce,re.width,re.height,re.depth),D)if(S.layerUpdates.size>0){const Y=Kc(re.width,re.height,S.format,S.type);for(const J of S.layerUpdates){const fe=re.data.subarray(J*Y/re.data.BYTES_PER_ELEMENT,(J+1)*Y/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,re.width,re.height,1,xe,Re,fe)}S.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,xe,Re,re.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Ce,re.width,re.height,re.depth,0,xe,Re,re.data);else if(S.isData3DTexture)Oe?(lt&&t.texStorage3D(r.TEXTURE_3D,le,Ce,re.width,re.height,re.depth),D&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,xe,Re,re.data)):t.texImage3D(r.TEXTURE_3D,0,Ce,re.width,re.height,re.depth,0,xe,Re,re.data);else if(S.isFramebufferTexture){if(lt)if(Oe)t.texStorage2D(r.TEXTURE_2D,le,Ce,re.width,re.height);else{let Y=re.width,J=re.height;for(let fe=0;fe<le;fe++)t.texImage2D(r.TEXTURE_2D,fe,Ce,Y,J,0,xe,Re,null),Y>>=1,J>>=1}}else if(Ye.length>0){if(Oe&&lt){const Y=Ee(Ye[0]);t.texStorage2D(r.TEXTURE_2D,le,Ce,Y.width,Y.height)}for(let Y=0,J=Ye.length;Y<J;Y++)ve=Ye[Y],Oe?D&&t.texSubImage2D(r.TEXTURE_2D,Y,0,0,xe,Re,ve):t.texImage2D(r.TEXTURE_2D,Y,Ce,xe,Re,ve);S.generateMipmaps=!1}else if(Oe){if(lt){const Y=Ee(re);t.texStorage2D(r.TEXTURE_2D,le,Ce,Y.width,Y.height)}D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,xe,Re,re)}else t.texImage2D(r.TEXTURE_2D,0,Ce,xe,Re,re);m(S)&&f(Q),Se.__version=Z.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function G(w,S,z){if(S.image.length!==6)return;const Q=Le(w,S),ne=S.source;t.bindTexture(r.TEXTURE_CUBE_MAP,w.__webglTexture,r.TEXTURE0+z);const Z=n.get(ne);if(ne.version!==Z.__version||Q===!0){t.activeTexture(r.TEXTURE0+z);const Se=Ve.getPrimaries(Ve.workingColorSpace),ue=S.colorSpace===qn?null:Ve.getPrimaries(S.colorSpace),_e=S.colorSpace===qn||Se===ue?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);const je=S.isCompressedTexture||S.image[0].isCompressedTexture,re=S.image[0]&&S.image[0].isDataTexture,xe=[];for(let J=0;J<6;J++)!je&&!re?xe[J]=_(S.image[J],!0,i.maxCubemapSize):xe[J]=re?S.image[J].image:S.image[J],xe[J]=ht(S,xe[J]);const Re=xe[0],Ce=s.convert(S.format,S.colorSpace),ve=s.convert(S.type),Ye=v(S.internalFormat,Ce,ve,S.colorSpace),Oe=S.isVideoTexture!==!0,lt=Z.__version===void 0||Q===!0,D=ne.dataReady;let le=P(S,Re);me(r.TEXTURE_CUBE_MAP,S);let Y;if(je){Oe&&lt&&t.texStorage2D(r.TEXTURE_CUBE_MAP,le,Ye,Re.width,Re.height);for(let J=0;J<6;J++){Y=xe[J].mipmaps;for(let fe=0;fe<Y.length;fe++){const de=Y[fe];S.format!==sn?Ce!==null?Oe?D&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe,0,0,de.width,de.height,Ce,de.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe,Ye,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe,0,0,de.width,de.height,Ce,ve,de.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe,Ye,de.width,de.height,0,Ce,ve,de.data)}}}else{if(Y=S.mipmaps,Oe&&lt){Y.length>0&&le++;const J=Ee(xe[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,le,Ye,J.width,J.height)}for(let J=0;J<6;J++)if(re){Oe?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,xe[J].width,xe[J].height,Ce,ve,xe[J].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ye,xe[J].width,xe[J].height,0,Ce,ve,xe[J].data);for(let fe=0;fe<Y.length;fe++){const Ne=Y[fe].image[J].image;Oe?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe+1,0,0,Ne.width,Ne.height,Ce,ve,Ne.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe+1,Ye,Ne.width,Ne.height,0,Ce,ve,Ne.data)}}else{Oe?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ce,ve,xe[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ye,Ce,ve,xe[J]);for(let fe=0;fe<Y.length;fe++){const de=Y[fe];Oe?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe+1,0,0,Ce,ve,de.image[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,fe+1,Ye,Ce,ve,de.image[J])}}}m(S)&&f(r.TEXTURE_CUBE_MAP),Z.__version=ne.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function ee(w,S,z,Q,ne,Z){const Se=s.convert(z.format,z.colorSpace),ue=s.convert(z.type),_e=v(z.internalFormat,Se,ue,z.colorSpace),je=n.get(S),re=n.get(z);if(re.__renderTarget=S,!je.__hasExternalTextures){const xe=Math.max(1,S.width>>Z),Re=Math.max(1,S.height>>Z);ne===r.TEXTURE_3D||ne===r.TEXTURE_2D_ARRAY?t.texImage3D(ne,Z,_e,xe,Re,S.depth,0,Se,ue,null):t.texImage2D(ne,Z,_e,xe,Re,0,Se,ue,null)}t.bindFramebuffer(r.FRAMEBUFFER,w),Xe(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Q,ne,re.__webglTexture,0,We(S)):(ne===r.TEXTURE_2D||ne>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Q,ne,re.__webglTexture,Z),t.bindFramebuffer(r.FRAMEBUFFER,null)}function K(w,S,z){if(r.bindRenderbuffer(r.RENDERBUFFER,w),S.depthBuffer){const Q=S.depthTexture,ne=Q&&Q.isDepthTexture?Q.type:null,Z=x(S.stencilBuffer,ne),Se=S.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ue=We(S);Xe(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ue,Z,S.width,S.height):z?r.renderbufferStorageMultisample(r.RENDERBUFFER,ue,Z,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,Z,S.width,S.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Se,r.RENDERBUFFER,w)}else{const Q=S.textures;for(let ne=0;ne<Q.length;ne++){const Z=Q[ne],Se=s.convert(Z.format,Z.colorSpace),ue=s.convert(Z.type),_e=v(Z.internalFormat,Se,ue,Z.colorSpace),je=We(S);z&&Xe(S)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,je,_e,S.width,S.height):Xe(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,je,_e,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,_e,S.width,S.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function oe(w,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(S.depthTexture);Q.__renderTarget=S,(!Q.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),X(S.depthTexture,0);const ne=Q.__webglTexture,Z=We(S);if(S.depthTexture.format===Xi)Xe(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ne,0,Z):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ne,0);else if(S.depthTexture.format===Qi)Xe(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ne,0,Z):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function Me(w){const S=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==w.depthTexture){const Q=w.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Q){const ne=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Q.removeEventListener("dispose",ne)};Q.addEventListener("dispose",ne),S.__depthDisposeCallback=ne}S.__boundDepthTexture=Q}if(w.depthTexture&&!S.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");oe(S.__webglFramebuffer,w)}else if(z){S.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer[Q]),S.__webglDepthbuffer[Q]===void 0)S.__webglDepthbuffer[Q]=r.createRenderbuffer(),K(S.__webglDepthbuffer[Q],w,!1);else{const ne=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Z=S.__webglDepthbuffer[Q];r.bindRenderbuffer(r.RENDERBUFFER,Z),r.framebufferRenderbuffer(r.FRAMEBUFFER,ne,r.RENDERBUFFER,Z)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=r.createRenderbuffer(),K(S.__webglDepthbuffer,w,!1);else{const Q=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ne=S.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ne),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,ne)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function pe(w,S,z){const Q=n.get(w);S!==void 0&&ee(Q.__webglFramebuffer,w,w.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),z!==void 0&&Me(w)}function it(w){const S=w.texture,z=n.get(w),Q=n.get(S);w.addEventListener("dispose",A);const ne=w.textures,Z=w.isWebGLCubeRenderTarget===!0,Se=ne.length>1;if(Se||(Q.__webglTexture===void 0&&(Q.__webglTexture=r.createTexture()),Q.__version=S.version,o.memory.textures++),Z){z.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[ue]=[];for(let _e=0;_e<S.mipmaps.length;_e++)z.__webglFramebuffer[ue][_e]=r.createFramebuffer()}else z.__webglFramebuffer[ue]=r.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let ue=0;ue<S.mipmaps.length;ue++)z.__webglFramebuffer[ue]=r.createFramebuffer()}else z.__webglFramebuffer=r.createFramebuffer();if(Se)for(let ue=0,_e=ne.length;ue<_e;ue++){const je=n.get(ne[ue]);je.__webglTexture===void 0&&(je.__webglTexture=r.createTexture(),o.memory.textures++)}if(w.samples>0&&Xe(w)===!1){z.__webglMultisampledFramebuffer=r.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let ue=0;ue<ne.length;ue++){const _e=ne[ue];z.__webglColorRenderbuffer[ue]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,z.__webglColorRenderbuffer[ue]);const je=s.convert(_e.format,_e.colorSpace),re=s.convert(_e.type),xe=v(_e.internalFormat,je,re,_e.colorSpace,w.isXRRenderTarget===!0),Re=We(w);r.renderbufferStorageMultisample(r.RENDERBUFFER,Re,xe,w.width,w.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ue,r.RENDERBUFFER,z.__webglColorRenderbuffer[ue])}r.bindRenderbuffer(r.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=r.createRenderbuffer(),K(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Z){t.bindTexture(r.TEXTURE_CUBE_MAP,Q.__webglTexture),me(r.TEXTURE_CUBE_MAP,S);for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0)for(let _e=0;_e<S.mipmaps.length;_e++)ee(z.__webglFramebuffer[ue][_e],w,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,_e);else ee(z.__webglFramebuffer[ue],w,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);m(S)&&f(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let ue=0,_e=ne.length;ue<_e;ue++){const je=ne[ue],re=n.get(je);t.bindTexture(r.TEXTURE_2D,re.__webglTexture),me(r.TEXTURE_2D,je),ee(z.__webglFramebuffer,w,je,r.COLOR_ATTACHMENT0+ue,r.TEXTURE_2D,0),m(je)&&f(r.TEXTURE_2D)}t.unbindTexture()}else{let ue=r.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ue=w.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ue,Q.__webglTexture),me(ue,S),S.mipmaps&&S.mipmaps.length>0)for(let _e=0;_e<S.mipmaps.length;_e++)ee(z.__webglFramebuffer[_e],w,S,r.COLOR_ATTACHMENT0,ue,_e);else ee(z.__webglFramebuffer,w,S,r.COLOR_ATTACHMENT0,ue,0);m(S)&&f(ue),t.unbindTexture()}w.depthBuffer&&Me(w)}function at(w){const S=w.textures;for(let z=0,Q=S.length;z<Q;z++){const ne=S[z];if(m(ne)){const Z=M(w),Se=n.get(ne).__webglTexture;t.bindTexture(Z,Se),f(Z),t.unbindTexture()}}}const He=[],L=[];function Zt(w){if(w.samples>0){if(Xe(w)===!1){const S=w.textures,z=w.width,Q=w.height;let ne=r.COLOR_BUFFER_BIT;const Z=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Se=n.get(w),ue=S.length>1;if(ue)for(let _e=0;_e<S.length;_e++)t.bindFramebuffer(r.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Se.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let _e=0;_e<S.length;_e++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(ne|=r.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(ne|=r.STENCIL_BUFFER_BIT)),ue){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Se.__webglColorRenderbuffer[_e]);const je=n.get(S[_e]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,je,0)}r.blitFramebuffer(0,0,z,Q,0,0,z,Q,ne,r.NEAREST),c===!0&&(He.length=0,L.length=0,He.push(r.COLOR_ATTACHMENT0+_e),w.depthBuffer&&w.resolveDepthBuffer===!1&&(He.push(Z),L.push(Z),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,L)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,He))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ue)for(let _e=0;_e<S.length;_e++){t.bindFramebuffer(r.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.RENDERBUFFER,Se.__webglColorRenderbuffer[_e]);const je=n.get(S[_e]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Se.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_e,r.TEXTURE_2D,je,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){const S=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[S])}}}function We(w){return Math.min(i.maxSamples,w.samples)}function Xe(w){const S=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function be(w){const S=o.render.frame;h.get(w)!==S&&(h.set(w,S),w.update())}function ht(w,S){const z=w.colorSpace,Q=w.format,ne=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Ft&&z!==qn&&(Ve.getTransfer(z)===st?(Q!==sn||ne!==On)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),S}function Ee(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=B,this.setTexture2D=X,this.setTexture2DArray=H,this.setTexture3D=$,this.setTextureCube=F,this.rebindTextures=pe,this.setupRenderTarget=it,this.updateRenderTargetMipmap=at,this.updateMultisampleRenderTarget=Zt,this.setupDepthRenderbuffer=Me,this.setupFrameBufferTexture=ee,this.useMultisampledRTT=Xe}function D_(r,e){function t(n,i=qn){let s;const o=Ve.getTransfer(i);if(n===On)return r.UNSIGNED_BYTE;if(n===ba)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Ta)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Gl)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===zl)return r.BYTE;if(n===Hl)return r.SHORT;if(n===Rs)return r.UNSIGNED_SHORT;if(n===Ea)return r.INT;if(n===_i)return r.UNSIGNED_INT;if(n===fn)return r.FLOAT;if(n===Ls)return r.HALF_FLOAT;if(n===Vl)return r.ALPHA;if(n===Wl)return r.RGB;if(n===sn)return r.RGBA;if(n===Xl)return r.LUMINANCE;if(n===Yl)return r.LUMINANCE_ALPHA;if(n===Xi)return r.DEPTH_COMPONENT;if(n===Qi)return r.DEPTH_STENCIL;if(n===wa)return r.RED;if(n===Aa)return r.RED_INTEGER;if(n===jl)return r.RG;if(n===Ra)return r.RG_INTEGER;if(n===Ca)return r.RGBA_INTEGER;if(n===_r||n===xr||n===vr||n===yr)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===_r)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===vr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===yr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===_r)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===vr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===yr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Bo||n===ko||n===zo||n===Ho)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Bo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ko)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===zo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ho)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Go||n===Vo||n===Wo)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Go||n===Vo)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Wo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Xo||n===Yo||n===jo||n===qo||n===Ko||n===Zo||n===$o||n===Qo||n===Jo||n===ea||n===ta||n===na||n===ia||n===sa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Xo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Yo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===jo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ko)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Zo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===$o)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Qo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Jo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ea)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ta)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===na)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ia)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===sa)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Mr||n===ra||n===oa)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Mr)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ra)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===oa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ql||n===aa||n===ca||n===la)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Mr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===aa)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ca)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===la)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===$i?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const U_=`
void main() {
...
`}dispose(){this.transformControl.detach(),this.transformControl.dispose(),this.uiOverlay.parentElement&&this.uiOverlay.parentElement.removeChild(this.uiOverlay),this.renderer.domElement.removeEventListener("pointerdown",this.onPointerDown.bind(this)),window.removeEventListener("keydown",this.onKeyDown.bind(this))}}class ux{renderer;environment;entities;scenario;tools;input;devEditor;isRunning=!1;ppeGroup=new Un;clock=new Vd;constructor(e){this.renderer=new V0(e),this.environment=new Y0(this.renderer.scene),this.entities=new j0(this.renderer.scene),this.ppeGroup.position.set(0,1e3,0);const t=mn.getModel(nn.MODELS.MAN);t&&(t.scene.scale.set(1.06,1.06,1.06),this.ppeGroup.add(t.scene)),this.renderer.scene.add(this.ppeGroup),this.setupPPETerrain(),new URLSearchParams(window.location.search).get("editMode")==="true"&&(this.devEditor=new lx(this.renderer.scene,this.renderer.camera,this.renderer.renderer,this.renderer.controls));let n=null;ke.subscribe(i=>{Ss.forEach(s=>{if(!s.models||s.models.length===0)return;const o=!!i.equippedPPE[s.id];s.models.forEach((a,c)=>{const l=`equipped-${s.id}-${c}`;let h=this.ppeGroup.getObjectByName(l);if(o){if(!h){const u=mn.getModel(a.modelPath);u&&(h=u.scene.clone(),h.name=l,a.manPosition&&h.position.set(a.manPosition[0],a.manPosition[1],a.manPosition[2]),a.manRotation&&h.rotation.set(a.manRotation[0],a.manRotation[1],a.manRotation[2]),a.manScale&&h.scale.set(a.manScale[0],a.manScale[1],a.manScale[2]),this.ppeGroup.add(h))}h&&(h.visible=!0)}else h&&(h.visible=!1)})}),this.scenario&&(this.scenario.setTelemetry(i.showPerfWarnings),this.scenario.setGravity(i.simulation.gravity),this.scenario.setShowTension(i.featureFlags.showTension)),this.applyDebugStyles(i),i.activeMode!==n&&(n=i.activeMode,i.activeMode==="PPE"?(this.stopSimulator(),this.devEditor&&this.devEditor.setTargetGroup(this.ppeGroup),this.ppeGroup.visible=!0,this.renderer.camera.position.set(0,1002,4),this.renderer.controls.target.set(0,1001,0),this.renderer.controls.update(),this.renderer.dirLight.position.set(10,1020,10),this.renderer.dirLight.target.position.set(0,1e3,0),this.renderer.dirLight.target.updateMatrixWorld(),this.renderer.scene.updateMatrixWorld(!0)):i.activeMode==="OHLEC"?(this.stopSimulator(),this.devEditor&&this.devEditor.setTargetGroup(null),this.ppeGroup.visible=!1,this.renderer.camera.position.set(0,2,4),this.renderer.controls.target.set(0,.5,0),this.renderer.controls.update(),this.renderer.dirLight.position.set(10,20,10),this.renderer.dirLight.target.position.set(0,0,0),this.renderer.dirLight.target.updateMatrixWorld(),this.renderer.scene.updateMatrixWorld(!0)):(this.devEditor&&this.devEditor.setTargetGroup(null),this.ppeGroup.visible=!1,this.renderer.camera.position.y>500&&(this.renderer.camera.position.set(0,2,4),this.renderer.controls.target.set(0,.5,0),this.renderer.controls.update()),this.renderer.dirLight.position.set(10,20,10),this.renderer.dirLight.target.position.set(0,0,0),this.renderer.dirLight.target.updateMatrixWorld(),this.renderer.scene.updateMatrixWorld(!0),this.startSimulator())),i.activeTool==="hand"?this.renderer.renderer.domElement.style.cursor="grab":this.renderer.renderer.domElement.style.cursor="default",i.chainsawStuck&&this.tools&&this.input&&(this.tools.throttleOn&&this.tools.setThrottle(!1),this.input.forceDetachGizmo())})}setupPPETerrain(){const n=new vi(100,100,200,200);n.rotateX(-Math.PI/2);const i=new Float32Array(40401),s=100/200;let o=0;for(let u=0;u<=200;u++){const d=-50+u*s,p=Math.sin(d*.1)*3+Math.sin(d*.03)*5;for(let g=0;g<=200;g++){const _=-50+g*s,m=Math.abs(_-p),f=2,M=4;let v=0;m<f?v=1:m<f+M&&(v=1-(m-f)/M,v=v*v*(3-2*v)),i[o]=v,o++}}n.computeVertexNormals(),n.setAttribute("pathIntensity",new ut(i,1));const a=mn.getTexture(nn.TEXTURES.LEAVES),c=mn.getTexture(nn.TEXTURES.MUD);a&&(a.wrapS=Nt,a.wrapT=Nt,a.repeat.set(20,20)),c&&(c.wrapS=Nt,c.wrapT=Nt,c.repeat.set(20,20));const l=new pn({map:a||null,color:a?16777215:5592405,roughness:.9});c&&(l.customProgramCacheKey=()=>"terrain_path_ppe",l.onBeforeCompile=u=>{u.uniforms.pathMap={value:c},u.vertexShader=u.vertexShader.replace("#include <common>",`#include <common>
  ...
  `);const e=document.getElementById("btn-dismiss-wip"),t=document.getElementById("modal-wip");e&&t&&e.addEventListener("click",()=>{t.remove()})}export{mn as A,Ss as P,ke as U,ux as a,hx as i,dx as s};
//# sourceMappingURL=wipModal-D3ln8fx2.js.map
